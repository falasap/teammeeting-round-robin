...
var Small = ({ className }) => /* @__PURE__ */ jsxs("svg", { width: "128", height: "128", viewBox: "0 0 128 128", fill: "none", xmlns: "http://www.w3.org/2000/svg", className, children: [
  ...
  /* @__PURE__ */ jsxs("g", { clipPath: "url(#clip0_6880_7422)", children: [
    ...
    /* @__PURE__ */ jsx("path", { d: "M91.4956 33H64.653C63.3647 33 62.3203 34.0444 62.3203 35.3327V74.5252C62.3203 75.8135 63.3647 76.8579 64.653 76.8579H91.4956C92.7839 76.8579 93.8283 75.8135 93.8283 74.5252V35.3327C93.8283 34.0444 92.7839 33 91.4956 33Z", fill: "var(--sapContent_Illustrative_Color17)" }),
    /* @__PURE__ */ jsx("path", { d: "M91.5402 33H65.4611C64.1968 33 63.1719 34.0249 63.1719 35.2892V74.1428C63.1719 75.4072 64.1968 76.4321 65.4611 76.4321H91.5402C92.8045 76.4321 93.8294 75.4072 93.8294 74.1428V35.2892C93.8294 34.0249 92.8045 33 91.5402 33Z", fill: "var(--sapContent_Illustrative_Color9)" }),
    /* @__PURE__ */ jsx("path", { d: "M90.3915 35.2842H66.5631C65.606 35.2842 64.8301 36.0601 64.8301 37.0172V72.7275C64.8301 73.6847 65.606 74.4606 66.5631 74.4606H90.3915C91.3486 74.4606 92.1246 73.6847 92.1246 72.7275V37.0172C92.1246 36.0601 91.3486 35.2842 90.3915 35.2842Z", fill: "var(--sapContent_Illustrative_Color8)" }),
    /* @__PURE__ */ jsx("path", { d: "M63.0862 47.303C63.0862 47.0445 62.8769 46.835 62.6188 46.835C62.3606 46.835 62.1514 47.0445 62.1514 47.303V48.7046C62.1514 48.9631 62.3606 49.1726 62.6188 49.1726C62.8769 49.1726 63.0862 48.9631 63.0862 48.7046V47.303Z", fill: "var(--sapContent_Illustrative_Color17)" }),
    /* @__PURE__ */ jsx("path", { d: "M62.8851 47.2024C62.8851 46.9995 62.7208 46.835 62.5182 46.835C62.3156 46.835 62.1514 46.9995 62.1514 47.2024V48.8051C62.1514 49.0081 62.3156 49.1726 62.5182 49.1726C62.7208 49.1726 62.8851 49.0081 62.8851 48.8051V47.2024Z", fill: "var(--sapContent_Illustrative_Color17)" }),
    /* @__PURE__ */ jsx("path", { d: "M85.2955 54.8284C85.2955 58.5813 82.2527 61.6241 78.4998 61.6241C74.7469 61.6241 71.7041 58.5813 71.7041 54.8284C71.7041 51.0755 74.7469 48.0327 78.4998 48.0327C82.2527 48.0327 85.2955 51.0755 85.2955 54.8284Z", fill: "var(--sapContent_Illustrative_Color23)" }),
    ...
    /* @__PURE__ */ jsx("path", { d: "M78.5 34.5396C78.7352 34.5396 78.9259 34.349 78.9259 34.1138C78.9259 33.8786 78.7352 33.688 78.5 33.688C78.2649 33.688 78.0742 33.8786 78.0742 34.1138C78.0742 34.349 78.2649 34.5396 78.5 34.5396Z", fill: "var(--sapContent_Illustrative_Color17)" }),
    ...
    /* @__PURE__ */ jsx("path", { d: "M59.2484 77.2551C59.6385 77.2551 59.9548 76.9388 59.9548 76.5487C59.9548 76.1585 59.6385 75.8423 59.2484 75.8423C58.8583 75.8423 58.542 76.1585 58.542 76.5487C58.542 76.9388 58.8583 77.2551 59.2484 77.2551Z", fill: "var(--sapContent_Illustrative_Color29)" }),
    /* @__PURE__ */ jsx("path", { d: "M61.4684 79.3225C60.7186 80.7886 58.8328 78.6719 56.7397 77.6018C54.6466 76.5329 51.2091 74.9066 51.8397 73.3846C52.0421 72.898 55.3866 74.1332 57.4796 75.2021C59.5727 76.271 61.4684 79.3212 61.4684 79.3212V79.3225Z", fill: "var(--sapContent_Illustrative_Color14)" }),
    /* @__PURE__ */ jsx("path", { d: "M52.1609 74.8294L53.524 71.2192C53.524 71.2192 59.7822 74.5885 60.6636 76.5947C61.5463 78.5997 60.6636 80.6865 60.6636 80.6865L52.1597 74.8294H52.1609Z", fill: "var(--sapContent_Illustrative_Color8)" }),
    /* @__PURE__ */ jsx("path", { d: "M40.7334 95.6608L51.8406 73.3843L61.4693 79.3209L60.5457 95.6596H40.7334V95.6608Z", fill: "var(--sapContent_Illustrative_Color21)" }),
  ...
  /* @__PURE__ */ jsx("defs", { children: /* @__PURE__ */ jsx("clipPath", { id: "clip0_6880_7422", children: /* @__PURE__ */ jsx("rect", { width: "60", height: "62", fill: "var(--sapContent_Illustrative_Color8)", transform: "translate(34 33)" }) }) })
] });
var Small_default = Small;

export { Small_default as default };
//# sourceMappingURL=Small-EUMXA72J.js.map
//# sourceMappingURL=Small-EUMXA72J.js.map
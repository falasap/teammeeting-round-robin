...
import { useRef, useId, useState, useCallback, useEffect, useImperativeHandle } from 'react';
...
function RadioButton({
  ...
  const [groupTabIndex, setGroupTabIndex] = useState(null);
  ...
  return /* @__PURE__ */ jsxs("div", { className: "relative inline-block max-w-full align-top", children: [
    /* @__PURE__ */ jsx(
      "input",
      {
        ref: inputRef,
    ...
    /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          ...
          valueState !== "None" /* None */ && /* @__PURE__ */ jsx("span", { id: descriptionId, className: "sr-only", children: valueStateMessage || defaultValueStateText }),
          accessibleDescription && /* @__PURE__ */ jsx("span", { id: `${id}-desc-text`, className: "sr-only", children: accessibleDescription })
        ]
      }
    )
  ] });
...
export { RadioButton, RadioButtonSize, RadioButtonValueState, RadioButtonWrappingType };
//# sourceMappingURL=chunk-2MAGJSMZ.js.map
//# sourceMappingURL=chunk-2MAGJSMZ.js.map
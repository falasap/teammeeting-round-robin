...
// node_modules/@sap-ui/fx-components/dist/Small-OM54SBL6.js
...
var Small = ({ className }) => (0, import_jsx_runtime.jsxs)("svg", { xmlns: "http://www.w3.org/2000/svg", width: "129", height: "128", fill: "none", viewBox: "0 0 129 128", className, children: [
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color20)", fillRule: "evenodd", d: "M128.5 49.6v36c0 5.298-4.302 9.6-9.6 9.6H10.1c-5.298 0-9.6-4.302-9.6-9.6v-36c0-5.298 4.302-9.6 9.6-9.6h108.8c5.298 0 9.6 4.302 9.6 9.6Z", clipRule: "evenodd" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color21)", fillRule: "evenodd", d: "m38.027 92.568 52.335-9.344c.325-.06.337-.517.02-.6L57.566 74.45a3.03 3.03 0 0 0-1.202-.055l-41.32 6.367c-.731.114-.872 1.104-.2 1.417l21.997 10.229c.368.172.787.227 1.19.153l-.004.007Z", clipRule: "evenodd" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color13)", d: "M92.162 34.664a1.57 1.57 0 0 1 .614.098 2.041 2.041 0 0 1 .998.822c.122.191.212.403.266.626l.975 4.238-63.367 3.815-.818-4.711c-.043-.25-.035-.49.024-.709a1.532 1.532 0 0 1 .81-1.006c.203-.1.434-.164.688-.18l59.81-2.993Z" }),
  ...
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color14)", d: "M40.758 85.469a1.97 1.97 0 0 1-.76-.059 2 2 0 0 1-.672-.344 2.117 2.117 0 0 1-.79-1.307l-6.884-39.496-.818-4.712a1.55 1.55 0 0 1-.027-.352 1.615 1.615 0 0 1 .152-.646 1.39 1.39 0 0 1 .168-.274l-1.037 1.35a2.403 2.403 0 0 0-.168.27 1.547 1.547 0 0 0-.153.638c0 .114 0 .231.028.349l.806 4.66 6.766 39.062c.043.266.14.509.274.728.133.219.31.41.505.563.2.153.422.266.665.34.243.071.497.095.751.06l60.714-7.67 1.745-.842-61.265 7.678v.004Z" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color9)", d: "M77.116 49.178c.81.662 1.565 1.386 2.254 2.168a18.681 18.681 0 0 1 3.256 5.26c.387.954.696 1.945.915 2.95.16.755.27 1.507.321 2.262.051.755.063 1.499.008 2.23a14.926 14.926 0 0 1-.92 4.258 13.465 13.465 0 0 1-.92 1.933 13.42 13.42 0 0 1-1.193 1.73 11.737 11.737 0 0 1-1.455 1.503c-.529.458-1.092.876-1.699 1.244a12.239 12.239 0 0 1-2.559 1.194 13.234 13.234 0 0 1-3.534.669c-.242.015-.489.02-.735.02-.247 0-.493-.005-.744-.02-.246-.016-.5-.032-.751-.055a15.835 15.835 0 0 1-4.445-1.143 17.184 17.184 0 0 1-2.114-1.06 17.97 17.97 0 0 1-3.8-3.013 18.414 18.414 0 0 1-1.577-1.867 18.508 18.508 0 0 1-2.355-4.261c-.298-.76-.536-1.53-.724-2.302a16.54 16.54 0 0 1-.392-2.328 15.837 15.837 0 0 1 .223-4.578c.15-.74.349-1.456.603-2.145.25-.688.56-1.342.908-1.968.348-.626.751-1.213 1.197-1.765.447-.552.932-1.06 1.46-1.526.528-.47 1.092-.885 1.69-1.252a13.044 13.044 0 0 1 1.863-.951 13.018 13.018 0 0 1 4.124-.947 14.187 14.187 0 0 1 2.908.113 15.75 15.75 0 0 1 2.869.685c.943.317 1.862.724 2.75 1.22a18.31 18.31 0 0 1 2.568 1.73v.016-.004Z" }),
...
//# sourceMappingURL=Small-OM54SBL6-T3PXX3CY.js.map

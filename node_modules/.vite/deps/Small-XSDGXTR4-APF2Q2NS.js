...
// node_modules/@sap-ui/fx-components/dist/Small-XSDGXTR4.js
...
var Small = ({ className }) => (0, import_jsx_runtime.jsxs)("svg", { width: "128", height: "128", viewBox: "0 0 128 128", fill: "none", xmlns: "http://www.w3.org/2000/svg", className, children: [
  ...
  (0, import_jsx_runtime.jsx)("path", { d: "M83.0455 35.5803L82.1014 32.8895C81.9047 32.3274 81.3582 31.9652 80.7649 32.0027L47.2321 33.5546C46.389 33.6076 45.8113 34.4195 46.033 35.2345L46.7117 37.585L83.0424 35.5803H83.0455Z", fill: "var(--sapContent_Illustrative_Color2)" }),
  (0, import_jsx_runtime.jsx)("path", { d: "M101.336 64.2247C101.336 64.2247 98.4508 68.1448 92.8473 68.8728C87.2438 69.6008 79.5573 65.453 77.5491 59.0719C75.3667 52.1369 79.3594 47.3845 86.1819 45.9057C92.4281 45.4077 101.336 64.2247 101.336 64.2247Z", fill: " var(--sapContent_Illustrative_Color16)" }),
  (0, import_jsx_runtime.jsx)("path", { d: "M102.093 55.4721C104.413 61.5447 101.162 67.2511 94.6167 68.0447C87.911 68.8576 80.6752 64.1923 78.6671 57.8079C76.7264 51.6421 80.4921 46.3759 86.8796 45.865C93.1258 45.367 99.8507 49.5922 102.097 55.4688L102.093 55.4721Z", fill: "var(--sapContent_Illustrative_Color15)" }),
  (0, import_jsx_runtime.jsx)("path", { d: "M96.9569 55.0441C96.8991 54.89 96.7446 54.7942 96.5808 54.811L91.8302 55.2981C91.665 55.3151 91.5094 55.2174 91.4527 55.0613L89.924 50.8467C89.8679 50.692 89.7146 50.5945 89.5507 50.6094L87.0438 50.8367C86.8083 50.8581 86.656 51.0958 86.7352 51.3187L88.1226 55.2264C88.2011 55.4476 88.0517 55.684 87.8181 55.708L83.2044 56.1813C82.9726 56.2051 82.8232 56.4384 82.8986 56.6589L83.6759 58.9309C83.7308 59.0913 83.8896 59.1922 84.0582 59.1737L89.0359 58.6276C89.2029 58.6093 89.3605 58.7082 89.4168 58.8665L90.9805 63.2679C91.0373 63.4276 91.1972 63.5267 91.3655 63.5062L93.9312 63.1948C94.1625 63.1667 94.3076 62.9306 94.2281 62.7116L92.7616 58.6707C92.6815 58.4499 92.8293 58.2125 93.0627 58.187L97.4727 57.7042C97.7078 57.6785 97.8555 57.4381 97.7725 57.2168L96.9569 55.0441Z", fill: "var(--sapContent_Illustrative_Color8)" })
] });
var Small_default = Small;
export {
  Small_default as default
};
//# sourceMappingURL=Small-XSDGXTR4-APF2Q2NS.js.map

...
// node_modules/@sap-ui/fx-components/dist/Medium-3QZ4CAQB.js
var import_jsx_runtime = __toESM(require_jsx_runtime(), 1);
var Medium = ({ className }) => (0, import_jsx_runtime.jsxs)("svg", { xmlns: "http://www.w3.org/2000/svg", width: "160", height: "160", fill: "none", viewBox: "0 0 160 160", className, children: [
  (0, import_jsx_runtime.jsx)("rect", { width: "160", height: "69", y: "50", fill: "var(--sapContent_Illustrative_Color20)", rx: "12" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color2)", d: "M22.881 68.863c0-.437-1.27-.788-2.967-.867-.097-1.695-.47-2.956-.908-2.954-.438 0-.802 1.27-.895 2.974-1.702.117-2.967.497-2.962.936.006.438 1.27.788 2.968.867.102 1.695.47 2.955.907 2.954.437 0 .802-1.27.896-2.974 1.702-.117 2.966-.497 2.961-.936Z" }),
  (0, import_jsx_runtime.jsx)("circle", { cx: "138.334", cy: "78.018", r: "1", fill: "var(--sapContent_Illustrative_Color20)" }),
  (0, import_jsx_runtime.jsx)("circle", { cx: "13.334", cy: "108.018", r: "1", fill: "var(--sapContent_Illustrative_Color20)" }),
  (0, import_jsx_runtime.jsx)("circle", { cx: "48.334", cy: "88.018", r: "1", fill: "var(--sapContent_Illustrative_Color20)" }),
  (0, import_jsx_runtime.jsx)("circle", { cx: "51.334", cy: "94.018", r: "1.5", fill: "var(--sapContent_Illustrative_Color20)" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color2)", d: "M27.15 75.513c0-.283-.822-.51-1.92-.561-.062-1.096-.304-1.911-.587-1.91-.283 0-.518.821-.578 1.923-1.101.075-1.92.322-1.916.605.004.284.822.51 1.92.561.065 1.096.304 1.911.586 1.91.282 0 .519-.821.58-1.923 1.1-.075 1.918-.321 1.914-.605Zm105.999 15c0-.283-.821-.51-1.919-.561-.062-1.096-.304-1.911-.587-1.91-.283 0-.518.821-.578 1.923-1.101.075-1.919.322-1.916.605.004.284.822.51 1.919.561.066 1.096.305 1.911.587 1.91.282 0 .519-.821.579-1.923 1.101-.075 1.919-.321 1.915-.605Z" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color24)", d: "M112.085 45.582c-3.434-1.283-4.372-.265-5.83 0-1.281 18.373-3.176 55.523 1.08 56.045 5.496.675 6.442 1.296 10.142-.449.966-.456 1.224-5.67 1.773-9.817.499-3.762 3.17-30.409 3.435-33.589.265-3.18.544-7.198-2.679-8.603-1.992-.868-6.365-3.006-7.921-3.587Z" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color1)", d: "M116.941 52.441c-.53-.742-8.119-5.018-12.448-5.416-2.208 16.784-6.532 52.697-5.79 53.015.927.397 13.515 2.517 15.105 2.252 1.59-.265.927-4.372 1.987-9.142s3.711-28.753 4.108-30.343c.398-1.59-2.299-9.438-2.962-10.366Z" }),
  ...
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color25)", d: "M80.206 59.376c.74-.822 2.542-.775 3.536-.432l.462-.875c.583.274 1.449.547 2.682 2.027 1.542 1.85 5.55 3.083 3.186 3.083s2.672 2.364.925 2.364c-6.793 0-8.64.825-8.838 3.134-.1 1.167 12.024 2.519 14.697 3.752 2.137.987.89 2.398 0 4.42-.583.822-1.768 2.59-1.85 3.083-.103.617 4.37 4.996-4.934 2.775-11.635-2.778-5.96 1.028-7.913 2.467-1.563 1.15-5.163 2.03-4.077 6.194-1.797-2.203-.92-5.042-.755-6.768.164-1.727 1.068-3.126 1.582-4.668-1.116-.23-2.455.819-3.03 1.394-.576.576-5.16 5.735-6.951 8.944.993-1.952 2.758-6.896 4.531-8.244 1.322-1.005 1.916-1.991 1.916-2.71 0-.72.862-1.258 0-1.954-2-1.614 1.916-4.507 1.338-6.05-1.318-3.514 4.436-4.272 4.436-5.402s-2.793-2.32-3.615-2.73c-.658-.33-.826-.527-1.214-.953.839-.963 3.146-2.028 3.886-2.85Z" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color24)", d: "M80.27 59.281c-.418.302-.574.518-1.135.935.605 1.477 3.736 2.713 5.566 3.721 1.143.63 5.237 2.178 6.967 1.462l-6.625-6.185c-.59-.164-1.93-.523-2.557-.639-.784-.145-1.693.328-2.216.706Z" }),
  ...
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color24)", d: "m81.564 69.56 3.11-1.54 15.277 3.099-2.231 2.045-16.156-3.604Z" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color1)", d: "m98.355 80.796-1.627 2.036.985-9.667 2.232-2.048-1.59 9.68Zm-15.969-9.682 13.956 3.028-.346 3.283-13.782-3.502.172-2.81Z" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color8)", d: "M83.656 57.432c0-.784 1.034-3.248 1.41-4.246 2.932-2.722 7.725-1.198 14.605.38 5.171 1.188 7.725 2.669 8.797 4.356 1.071 1.688-.911 3.29-2.087 4.192-2.199 1.688-7.894 3.376-12.35 3.43-4.454.055-7.234-2.026-8.965-3.43-1.559-1.264-1.41-3.702-1.41-4.682Z" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color25)", d: "M83.832 58.422c-.614-.964.42-3.223.823-3.99 1.808-5.37 19.96.236 21.549.565 1.589.329 2.905 1.753 0 4.493-2.904 2.74-10.849 3.288-14.52 2.959-3.671-.329-7.085-2.821-7.852-4.027Z" }),
  ...
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color25)", d: "M104.84 35.847c2.795 1.55 4.471 4.514 4.824 5.318.848 1.938.872 3.685.872 5.09-1.285-5.878-6.458-10.408-14.273-10.408-5.261 0-5.364-.873-2.515-1.481 2.849-.608 7.597-.456 11.092 1.481Z" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color24)", d: "M91.96 34.614c-2.416.554-4.858 2.712-6.011 4.02-2.83 3.589-2.822 5.093-3.518 9.531-.697 4.439 2.485 8.346 2.485 8.346-1.765-5.025-1.032-12.423 2.775-16.814 6.144-7.086 15.585-4.75 12.973-5.279-3.048-.617-5.71-.49-8.703.196Z" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color22)", d: "M93.677 60.403c6.044.158 10.123-2.337 11.407-3.605.231-.527.751-1.728.988-2.32-1.235-.643-.988-1.877-.988-3.359 0-1.185.889-1.91 1.334-2.123.098-.099.108-.82-.642-2.914-.939-2.617-3.556-5.382-8.494-6.962s-8.05.395-10.913 2.32c-2.865 1.926-2.815 8.988-2.519 10.864.296 1.877 2.272 7.902 9.827 8.1Z" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color8)", d: "M85.261 52.434c-1.704-5.755 1.13-9.718 2.781-10.699.837-.497-1.613 2.313-2.275 4.577-1.041 3.562.453 7.821-.506 6.122Z" }),
  (0, import_jsx_runtime.jsx)("circle", { cx: "91.875", cy: "42.192", r: ".515", fill: "var(--sapContent_Illustrative_Color8)" }),
  (0, import_jsx_runtime.jsx)("circle", { cx: "88.826", cy: "43.849", r: ".515", fill: "var(--sapContent_Illustrative_Color8)" }),
  (0, import_jsx_runtime.jsx)("circle", { cx: "91.36", cy: "48.283", r: "1.03", fill: "var(--sapContent_Illustrative_Color8)" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color24)", d: "m105.109 82.203 3.688 2.098-1.78 11.254c-.127 1.124.068 2.258.373 3.224.382 1.209-.119 2.372-.373 2.944-.204.458.416 1.517.373 2.196-.508-.806-2.153-2.298-1.645-3.467.636-1.463.445-2.035-.636-5.85-1.081-3.815-.635-6.563 0-8.852.509-1.831.424-3.293 0-3.547Z" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color25)", d: "M103.429 86.288c.316-.737.394-2.588.394-3.42l2.237 1.183c0 .548-.118 1.947-.592 3.158-.474 1.21.197 8.134.592 11.445-.439-1.184-1.5-3.683-2.237-4.21-.92-.657-4.801-.329-4.275-.526.526-.197 2.565-.197 3.881-.526 1.315-.329.394-1.25 0-1.974-.395-.723-1.382-1.578-2.105-1.907-.724-.329-.526-.395 0-.79.526-.394 1.71-1.512 2.105-2.433Z" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color24)", d: "M74.398 80.84v-4.43c.6.4 1.883 1.209 2.216 1.246.415.046 1.154-1.016 2.077-2.216.923-1.2.326-.163 1.178 1.235 1.553 2.544-.733 5-.933 4.985.216 1.062.013 2.163-.245 3.53-.323 1.707-2.077 3.064-1.132 5.133.83 1.816-.945-.492-.945-2.08 0-.94.37-3.086.9-4.98.114-.41.648-1.78 1.177-3.253-.277-.046-1.016.185-1.662.462-.646.277-2.03 3.58-4.25 4.717-.857.44-2.247 4.2-4.574 5.67.754-1.446 2.14-2.514 2.327-5.215.122-1.754 3.866-4.526 3.866-4.803Z" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color25)", d: "M105.347 50.062c.427-.601 1.653-.966 2.12-.977-.587.49-1.207.88-1.304 2.576-.098 1.696 1.203 2.41.526 2.41-.628 0-1.134.096-1.493-.62-.358-.718-.512-2.455.151-3.39Z" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color22)", d: "M75.104 104.569c-.546-1.077-.733-2.676-.2-3.21.294.347.775 2.258 2.391 4.118 1.176 1.353 5.003 4.936 10.205 8.455l.132 1.816c-1.2-.72-4.04-2.713-6.087-4.184-2.559-1.84-5.622-5.379-6.441-6.995Zm27.179-31.779c.956-3.468 4.649-8.782 5.945-8.832l1.43-.42c.668-.21 3.281 1.395 1.812 1.222-1.39-.162-6.84 6.91-7.322 8.58-.483 1.67-.808 3.837-.38 6.647.343 2.247 3.476 3.93 5.027 4.46l1.23.661c-1.397 1.944-3.868.947-6.257-2.043-2.769-3.467-2.681-5.94-1.485-10.275Zm-23.098-3.332c.37-2.223 1.436-10.23 3.112-10.913h1.38s-.005.312.1 1.129c-.791.59-.877 2.237-1.155 2.747-.347.636-2.456 14.367-2.167 15.583.232.972-1.742 2.989-2.379 3.741l.508-1.847c.155-2.701.23-8.218.6-10.44Z" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color25)", d: "M109.369 53.583c-1.289 1.464-2.532.908-3.317.894 0 .228-.639 1.499-1.393 2.424-.754.925-2.389 1.911-5.5 2.891 0 0 2.769-.084 4.159-.653 1.39-.569 2.753-2.834 3.512-2.632.975.26 2.98-3.424 2.539-2.924Z" })
] });
var Medium_default = Medium;
export {
  Medium_default as default
};
//# sourceMappingURL=Medium-3QZ4CAQB-Q3JHPAST.js.map

...
// node_modules/@sap-ui/fx-components/dist/Medium-45IHLGVO.js
...
var Medium = ({ className }) => (0, import_jsx_runtime.jsxs)("svg", { xmlns: "http://www.w3.org/2000/svg", width: "160", height: "160", fill: "none", viewBox: "0 0 160 160", className, children: [
  ...
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color14)", d: "m95.36 71.452-.085-.289c-.01-.04 1.205-.104 1.27-.104 1.135.025 2.256.318 3.292.777 3.133 1.384 5.454 4.089 7.112 7.008a8.48 8.48 0 0 1 .817 6.265 9.259 9.259 0 0 1-.348 1.031c-.105.26-.175.638-.429.797-.304.19-.124-.428-.104-.577.159-1.32.274-2.65.094-3.975-.149-1.106-.468-2.162-.826-3.213-.533-1.514-1.276-3.008-2.366-4.198a10.816 10.816 0 0 0-4.1-2.765c-1.384-.528-2.853-.722-4.328-.747v-.01Z", opacity: ".9" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color13)", d: "M120.412 49.043 95.274 71.168s9.892-.797 12.029 11.525c0 0 .568 9.125-5.583 8.099 0 0-1.445.438 2.794.105a.771.771 0 0 0 .363-.125L119.69 81l27.624-22.703 1.962-9.254h-28.869.005Z", opacity: ".9" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color16)", fillRule: "evenodd", d: "M69.563 72.475s-2.8 6.848-6.231 10.649l-.394-.503 6.625-10.146Z", clipRule: "evenodd", opacity: ".9" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color31)", d: "M76.502 97.353c-.15.044.164 1.15.2 1.26a2.78 2.78 0 0 0 1.105 1.419c1.405.907 3.118.18 4.353-.672a16.82 16.82 0 0 0 2.939-2.575c.543-.598 1.15-1.236 1.454-1.993.573-1.414-.533-2.67-1.863-3.038-.313-.085-.697-.174-1.016-.065-.503.17-.886.842-1.225 1.226l-1.35 1.514c-.518.583-1.04 1.17-1.648 1.658-.902.728-1.873.937-2.949 1.27v-.004Z", opacity: ".9" }),
  ...
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color31)", d: "M71.939 93.717c-.05.025-.06.359-.065.419-.015.14-.025.284-.03.428-.015.304 0 .613.055.912.2 1.09 1.225 2.072 2.336 2.186.144.015.289.015.438 0 .449-.03.897-.154 1.34-.239 1.206-.229 2.401-.603 3.412-1.315.528-.373.931-.827 1.35-1.32.503-.597 1.06-1.155 1.569-1.753.393-.468.757-.971.842-1.599.209-1.564-1.664-2.515-3.009-2.31-.916.139-1.579.801-2.271 1.349-.598.478-1.18.971-1.748 1.48-.22.198-.379.438-.668.452-.17.01-.353-.03-.528-.044l-.568-.02-2.44 1.37-.015.004Z", opacity: ".9" }),
  ...
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color31)", d: "m66.889 89.155.01 1.11c0 .364.164.772.299 1.096a4.174 4.174 0 0 0 1.08 1.54c.165.149.344.278.534.393a3.38 3.38 0 0 0 1.41.488c.557.055 1.11-.07 1.658-.18.463-.094.926-.174 1.38-.308.582-.17 1.25-.423 1.603-.947.29-.428.27-1.016.105-1.489a2.301 2.301 0 0 0-1.17-1.33c-.553-.259-1.186-.254-1.769-.134-.478.1-.941.274-1.414.398-.678.18-1.355.224-2.003-.094-.224-.11-.483-.185-.717-.28-.329-.129-.692-.208-1.021-.338l.035.07-.02.005Z", opacity: ".9" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color8)", d: "M72.073 90.544s1.774 1.873 1.774 1.877c-.015-.015-.683.294-.752.32-.663.223-1.594.248-2.157-.23-.458-.393-.692-1.15-.12-1.559.185-.13.394-.19.598-.274.1-.04.558-.239.657-.134Z", opacity: ".9" }),
  ...
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color16)", d: "M90.14 92.49c.303.509.747 1.042 1.09 1.53.752 1.08 1.5 2.181 1.918 3.432.04.12.14.249.259.284-.055 0 .05.014 0 0 .528.01 1.096.02 1.554-.3.184-.129.473-.333.518-.552-.339.219-.553.249-.792.363-.578.27-.931-.064-1.315-.577-.827-1.091-1.564-2.297-2.226-3.497a11.22 11.22 0 0 1-.772-1.688 7.875 7.875 0 0 1-.25-.892c-.054-.264-.014-.618-.129-.857-.184.24-.194.708-.22.996-.044.568.056 1.21.34 1.709.01.015.015.03.025.045v.005Zm1.658-8.537s.697 4.09 3.168 6.037l.97.921-.124.125s-.523-.25-.772-.498l1.619 3.342s.25.543 1.38-1.011l.747-.927-.458.827c-.429.792-.917 1.176-1.375 1.435-.204.114-.364.184-.334.104l-3.058-5.035s-2.147-3.367-1.768-5.31l.005-.01Z", opacity: ".9" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color16)", d: "M84.202 76.856c-.04-.374.04-.652.105-.981.05-.264 1.733.548 1.977.657 1.235.533 2.44 1.13 3.646 1.729.802.398 1.614.797 2.306 1.36 1.39 1.125 2.296 2.734 3.517 4.029 1.434 1.519 5.095 4.667 3.81 6.41-.145.2-.18.513-.284.732.144-.418.14-.986.18-1.43.094-1.01-.34-1.344-.962-2.056a8543.072 8543.072 0 0 1-5.305-6.072c-1.788-2.047-4.791-3.262-7.276-4.323-.454.742-.907 1.489-1.36 2.231 0-.622 0-1.245-.005-1.868 0-.074-.324-.274-.339-.423l-.01.005Z", opacity: ".9" }),
  ...
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color9)", fillRule: "evenodd", d: "M11.612 49.045c1.226 4.443 2.177 7.75 2.346 7.85 1.43.806-.388 1.598 1.041 2.405 2.072 1.17 1.26 3.651 3.332 4.822 2.47 1.39 1.2.573 7.865 4.796 2.61 1.47 5.22 2.944 7.835 4.413l7.506 4.229c2.142 1.21 4.288 2.416 6.43 3.621 1.534.867 3.068 1.728 4.602 2.595 1.39.782 2.745 1.614 4.15 2.366l4.024-.757c1.365-1.206 2.515-2.655 3.596-4.11 2.122-2.873 3.975-5.961 5.573-9.16l-22.04-23.07h-36.26Z", clipRule: "evenodd" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color14)", d: "M104.31 86.275c-.15.458-.548.777-.927.752-.408-.03-.697-.448-.612-.986.094-.608.602-1.051 1.085-.932.439.115.618.658.454 1.166Z", opacity: ".9" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color17)", d: "M49.945 79.725c-1.017-.084-1.843-.931-1.848-1.902 0-.966.822-1.684 1.843-1.604 1.016.085 1.843.931 1.847 1.903 0 .966-.821 1.683-1.842 1.603Zm6.32 4.105c-1.016-.084-1.843-.93-1.848-1.902 0-.966.822-1.683 1.843-1.604 1.016.085 1.843.932 1.848 1.903 0 .966-.822 1.684-1.843 1.604Z", opacity: ".9" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color3)", fillRule: "evenodd", d: "M100.136 87.202s-.245.657-.444.722c-.274.08-.538-.503-.538-.503l.902-.24.084.026-.004-.005Z", clipRule: "evenodd", opacity: ".9" })
] });
var Medium_default = Medium;
export {
  Medium_default as default
};
//# sourceMappingURL=Medium-45IHLGVO-P5VLCGZW.js.map

...
// node_modules/@sap-ui/fx-components/dist/ExtraSmall-2NR5RXXM.js
...
var ExtraSmall = ({ className }) => (0, import_jsx_runtime.jsxs)("svg", { xmlns: "http://www.w3.org/2000/svg", width: "45", height: "45", fill: "none", viewBox: "0 0 45 45", className, children: [
  (0, import_jsx_runtime.jsxs)("g", { clipPath: "url(#a)", children: [
    (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color21)", fillRule: "evenodd", d: "m12.063 39.897 26.502-4.733c.164-.03.17-.261.01-.303l-16.618-4.14a1.534 1.534 0 0 0-.608-.027L.425 33.918a.378.378 0 0 0-.101.717l11.138 5.18a.998.998 0 0 0 .603.078l-.002.004Z", clipRule: "evenodd" }),
    (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color13)", d: "M39.477 10.575a.793.793 0 0 1 .311.05 1.032 1.032 0 0 1 .505.416c.062.097.107.204.135.317l.494 2.146-32.089 1.932-.414-2.386a.834.834 0 0 1 .012-.358.787.787 0 0 1 .41-.51.898.898 0 0 1 .349-.09l30.287-1.517Z" }),
    (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color25)", d: "m8.831 15.436 32.086-1.93 4.124 17.931c.028.121.032.24.02.35a.81.81 0 0 1-.101.3.662.662 0 0 1-.492.327l-31.024 3.888a.96.96 0 0 1-.384-.03.944.944 0 0 1-.341-.174 1.092 1.092 0 0 1-.26-.287 1.022 1.022 0 0 1-.14-.373L8.833 15.436h-.002Z" }),
    (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color14)", d: "M13.446 36.3a.996.996 0 0 1-.384-.03 1.07 1.07 0 0 1-.741-.836l-3.486-20-.414-2.386a.818.818 0 0 1 .063-.505.704.704 0 0 1 .085-.139l-.525.684a1.2 1.2 0 0 0-.085.137.784.784 0 0 0-.077.323c0 .057 0 .117.014.176l.408 2.36 3.426 19.78a1.071 1.071 0 0 0 .394.654c.101.078.214.135.337.173a.911.911 0 0 0 .38.03l30.745-3.884.884-.426-31.024 3.888v.002Z" }),
    (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color9)", d: "M31.857 17.923c.41.335.792.701 1.141 1.098a9.544 9.544 0 0 1 1.649 2.663c.196.483.353.985.464 1.494.08.383.136.763.162 1.145a7.965 7.965 0 0 1-.15 2.232c-.078.36-.183.713-.312 1.054a6.818 6.818 0 0 1-1.07 1.855 6.315 6.315 0 0 1-2.227 1.73 6.396 6.396 0 0 1-1.363.457 7.117 7.117 0 0 1-1.465.157 6.03 6.03 0 0 1-.376-.01c-.125-.008-.254-.016-.38-.028a8.016 8.016 0 0 1-2.251-.579 8.712 8.712 0 0 1-2.08-1.23 9.32 9.32 0 0 1-2.382-2.818 9.095 9.095 0 0 1-.892-2.283 8.364 8.364 0 0 1-.225-2.352c.02-.388.065-.77.14-1.145.076-.375.177-.737.306-1.086.127-.349.283-.68.46-.997.176-.317.38-.614.606-.893a6.343 6.343 0 0 1 2.538-1.889 6.542 6.542 0 0 1 2.089-.48c.49-.031.983-.011 1.472.058a8.208 8.208 0 0 1 2.846.965 9.28 9.28 0 0 1 1.3.876v.008-.002Z" }),
...
//# sourceMappingURL=ExtraSmall-2NR5RXXM-R53ONYUJ.js.map

...
// node_modules/@sap-ui/fx-components/dist/Medium-REY3ZJCM.js
...
var Medium = ({ className }) => (0, import_jsx_runtime.jsxs)("svg", { width: "160", height: "160", viewBox: "0 0 160 160", fill: "none", xmlns: "http://www.w3.org/2000/svg", className, children: [
  ...
  (0, import_jsx_runtime.jsxs)("g", { clipPath: "url(#clip0_6879_7323)", children: [
    ...
    (0, import_jsx_runtime.jsxs)("g", { clipPath: "url(#clip1_6879_7323)", children: [
      ...
      (0, import_jsx_runtime.jsx)("path", { d: "M86.6477 72.5854C86.314 71.4423 86.1205 70.2816 85.975 69.0926C85.9412 68.817 85.9377 68.4637 85.8135 68.2075C85.3893 68.9919 85.7709 72.2303 86.0957 73.2903C86.4329 74.3874 86.9121 75.4528 87.0257 76.6064C87.0825 77.1859 86.9955 77.7636 86.9458 78.3395C86.8926 78.9597 86.8464 79.5798 86.8092 80.2016C86.7843 80.5974 86.8234 82.6538 86.8553 84.0584C86.8589 84.1838 87.0434 84.1944 87.0594 84.069C87.2192 82.8217 87.4322 81.0991 87.441 80.7458C87.457 80.1946 87.7995 77.1647 86.8606 73.2568C86.8056 73.0271 86.7133 72.8098 86.6477 72.5854Z", fill: "var(--sapContent_Illustrative_Color30)" }),
      (0, import_jsx_runtime.jsx)("path", { d: "M71.4902 100.621C71.8185 101.598 71.9853 102.621 71.9853 103.651V119H76C76.1757 114.737 76.1794 110.126 75.7818 108.183C75.3771 106.207 74.9725 104.193 74.085 102.367C73.2792 100.709 72.2303 99.1812 71.4387 97.5152C71.0553 96.7096 70.7323 95.8704 70.5406 94.9959C70.3276 94.0189 70.2921 93.0154 70.3862 92.0225C70.5246 90.5615 70.908 89.1287 71.1387 87.6782C71.0216 87.8266 70.8956 87.9839 70.7518 88.1517C69.4597 89.6728 68.4604 95.4641 69.8111 97.1601C70.5406 98.0753 71.1157 99.4992 71.4902 100.619V100.621Z", fill: "var(--sapContent_Illustrative_Color30)" }),
      (0, import_jsx_runtime.jsx)("path", { d: "M77.1786 70.2288C77.1786 70.2288 76.6585 70.4249 76.5946 71.4567C76.5627 71.9602 76.5307 72.3877 76.5041 72.6951C76.481 72.9707 76.7011 73.2057 76.978 73.2057H77.9347C77.9347 73.2057 78.3163 70.5751 77.9347 70.3225C77.5531 70.0698 77.1768 70.2271 77.1768 70.2271L77.1786 70.2288Z", fill: "var(--sapContent_Illustrative_Color30)" }),
      (0, import_jsx_runtime.jsx)("path", { d: "M79.6439 68.6847H80.4071C80.6184 68.6847 80.7958 68.5292 80.8225 68.3225C80.929 67.5028 81.0851 65.5718 80.1888 65.5099C79.0707 65.4322 79.1558 67.1123 79.2251 68.2925C79.2375 68.5133 79.4221 68.6847 79.6439 68.6847Z", fill: "var(--sapContent_Illustrative_Color30)" }),
      (0, import_jsx_runtime.jsx)("path", { d: "M82.9896 68.5837H84.3386C84.5391 68.5837 84.7113 68.4406 84.745 68.2428C84.8906 67.3895 85.1373 65.2182 83.8895 65.1493C82.3471 65.0645 82.4838 66.9248 82.5779 68.2021C82.5938 68.4159 82.7731 68.582 82.9896 68.582V68.5837Z", fill: "var(--sapContent_Illustrative_Color30)" }),
      (0, import_jsx_runtime.jsx)("path", { d: "M87.379 70.4689L88.428 70.1916C88.6267 70.1386 88.7581 69.9513 88.7386 69.7464C88.6605 68.9531 88.3623 67.1193 87.3062 67.3383C85.9946 67.6104 86.5004 69.1298 86.8732 70.2022C86.9459 70.4089 87.166 70.5255 87.3772 70.4689H87.379Z", fill: "var(--sapContent_Illustrative_Color30)" })
    ] })
  ] }),
  (0, import_jsx_runtime.jsxs)("defs", { children: [
    (0, import_jsx_runtime.jsx)("clipPath", { id: "clip0_6879_7323", children: (0, import_jsx_runtime.jsx)("rect", { width: "98", height: "75", fill: "var(--sapContent_Illustrative_Color8)", transform: "translate(30 44)" }) }),
    (0, import_jsx_runtime.jsx)("clipPath", { id: "clip1_6879_7323", children: (0, import_jsx_runtime.jsx)("rect", { width: "95", height: "75", fill: "var(--sapContent_Illustrative_Color8)", transform: "translate(33 44)" }) })
  ] })
] });
...
//# sourceMappingURL=Medium-REY3ZJCM-2BV5HN6G.js.map

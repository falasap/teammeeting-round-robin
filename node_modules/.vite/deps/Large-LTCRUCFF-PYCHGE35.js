...
// node_modules/@sap-ui/fx-components/dist/Large-LTCRUCFF.js
...
var Large = ({ className }) => (0, import_jsx_runtime.jsxs)("svg", { width: "320", height: "240", viewBox: "0 0 320 240", fill: "none", xmlns: "http://www.w3.org/2000/svg", className, children: [
  ...
  (0, import_jsx_runtime.jsx)("path", { d: "M240.84 103.729C247.649 122.737 237.377 140.61 216.884 143.059C195.486 145.612 172.583 130.372 166.809 109.724C161.035 89.0749 174.045 73.6687 194.371 72.7312C213.892 71.8308 234.298 85.4485 240.847 103.729H240.84Z", fill: "var(--sapContent_Illustrative_Color15)" }),
  (0, import_jsx_runtime.jsx)("path", { d: "M236.274 104.099C242.116 120.634 233.059 136.052 215.292 138.081C196.843 140.185 177.13 127.066 172.069 109.304C167.187 92.171 178.121 77.9735 195.765 77.0793C212.801 76.222 230.631 88.119 236.281 104.099H236.274Z", fill: "var(--sapContent_Illustrative_Color25)" }),
  (0, import_jsx_runtime.jsx)("path", { d: "M240.592 196.444L228.921 199.54L210.379 140.548L221.313 139.278L240.592 196.444Z", fill: "var(--sapContent_Illustrative_Color15)" }),
  (0, import_jsx_runtime.jsx)("path", { d: "M171.455 95.9886L195.585 77.0916C182.91 77.8008 173.735 85.3868 171.455 95.9886Z", fill: "var(--sapContent_Illustrative_Color25)" }),
  (0, import_jsx_runtime.jsx)("path", { d: "M215.292 138.081C230.965 136.293 239.855 124.087 237.724 109.884L199.116 136.256C204.351 137.995 209.877 138.698 215.292 138.081Z", fill: "var(--sapContent_Illustrative_Color8)" }),
  (0, import_jsx_runtime.jsx)("path", { d: "M217.256 82.4202L217.243 82.4141L217.256 82.4202Z", fill: "var(--sapContent_Illustrative_Color25)" }),
  (0, import_jsx_runtime.jsx)("path", { d: "M195.759 77.079C196.26 77.0545 196.756 77.0422 197.258 77.0361C196.756 77.0361 196.26 77.0545 195.759 77.079Z", fill: "var(--sapContent_Illustrative_Color25)" }),
  (0, import_jsx_runtime.jsx)("path", { d: "M211.971 79.9101C212.126 79.9718 212.281 80.0334 212.43 80.0951C212.275 80.0334 212.126 79.9718 211.971 79.9101Z", fill: "var(--sapContent_Illustrative_Color25)" }),
  (0, import_jsx_runtime.jsx)("path", { d: "M213.377 80.4899C213.483 80.5392 213.588 80.5885 213.693 80.6317C213.588 80.5824 213.483 80.533 213.377 80.4899Z", fill: "var(--sapContent_Illustrative_Color25)" }),
  (0, import_jsx_runtime.jsx)("path", { d: "M210.546 79.3735C210.72 79.4352 210.899 79.4969 211.073 79.5647C210.899 79.4969 210.726 79.4352 210.546 79.3735Z", fill: "var(--sapContent_Illustrative_Color25)" }),
  (0, import_jsx_runtime.jsx)("path", { d: "M200.907 77.2026C201.192 77.2271 201.477 77.2578 201.768 77.2945C201.483 77.2639 201.198 77.2332 200.907 77.2026Z", fill: "var(--sapContent_Illustrative_Color25)" }),
  (0, import_jsx_runtime.jsx)("path", { d: "M199.364 77.0916C199.662 77.1099 199.965 77.1222 200.262 77.1467C199.965 77.1222 199.662 77.1038 199.364 77.0916Z", fill: "var(--sapContent_Illustrative_Color25)" }),
  (0, import_jsx_runtime.jsx)("path", { d: "M202.425 77.3752C202.703 77.412 202.988 77.4549 203.267 77.4979C202.988 77.4549 202.71 77.412 202.425 77.3752Z", fill: "var(--sapContent_Illustrative_Color25)" }),
  (0, import_jsx_runtime.jsx)("path", { d: "M197.76 77.0422C198.094 77.0422 198.423 77.0484 198.757 77.0606C198.423 77.0484 198.088 77.0422 197.76 77.0422Z", fill: "var(--sapContent_Illustrative_Color25)" }),
  (0, import_jsx_runtime.jsx)("path", { d: "M237.997 112.45C237.08 94.0829 219.356 79.3921 201.762 77.2026C195.641 76.6414 184.88 76.6414 177.068 85.0969C176.188 86.0467 175.364 87.1569 174.596 88.3287C174.466 88.526 174.392 88.6617 174.274 88.8529C174.255 88.8776 174.249 88.9084 174.231 88.9393C183.492 77.8317 198.299 77.1224 211.383 82.3031C224.925 87.6626 236.621 99.3376 237.997 112.462V112.45Z", fill: "var(--sapContent_Illustrative_Color16)" }),
  (0, import_jsx_runtime.jsx)("path", { d: "M192.686 79.3613L171.455 95.9887C170.582 100.059 170.718 104.568 172.069 109.304C172.18 109.699 172.304 110.087 172.434 110.476L213.514 83.2097C206.786 80.2062 199.5 78.7137 192.686 79.3613Z", fill: "var(--sapContent_Illustrative_Color8)" }),
  (0, import_jsx_runtime.jsx)("path", { d: "M205.931 142.88L212.293 146.636C212.293 146.636 210.968 143.361 215.329 142.911V142.843C213.582 143.108 210.063 143.46 205.931 142.874V142.88Z", fill: "var(--sapContent_Illustrative_Color16)" }),
  (0, import_jsx_runtime.jsx)("path", { d: "M219.95 142.257C220.836 142.294 222.385 142.948 223.122 144.829L224.175 141.412C224.175 141.412 223.203 141.881 219.95 142.251V142.257Z", fill: "var(--sapContent_Illustrative_Color16)" }),
  (0, import_jsx_runtime.jsx)("path", { d: "M228.921 199.54L211.538 144.298L212.708 143.126C212.708 143.126 214.932 142.997 217.46 142.491C217.46 142.491 216.587 143.472 216.841 144.829C217.857 150.157 234.385 198.504 234.385 198.504L228.915 199.54H228.921Z", fill: "var(--sapContent_Illustrative_Color16)" }),
  (0, import_jsx_runtime.jsx)("path", { d: "M240.592 196.444C240.592 197.085 237.582 198.152 232.657 199.417C230.222 199.904 229.026 199.842 228.921 199.54C228.847 199.324 230.179 198.492 232.595 197.714C236.213 196.586 240.184 195.951 240.592 196.444Z", fill: "var(--sapContent_Illustrative_Color16)" })
] });
var Large_default = Large;
export {
  Large_default as default
};
//# sourceMappingURL=Large-LTCRUCFF-PYCHGE35.js.map

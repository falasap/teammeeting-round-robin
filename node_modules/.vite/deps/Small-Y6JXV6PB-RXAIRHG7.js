...
// node_modules/@sap-ui/fx-components/dist/Small-Y6JXV6PB.js
...
var Small = ({ className }) => (0, import_jsx_runtime.jsxs)("svg", { xmlns: "http://www.w3.org/2000/svg", width: "128", height: "128", fill: "none", viewBox: "0 0 128 128", className, children: [
  ...
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color21)", fillRule: "evenodd", d: "m39.9 92.272 58.706-8.529c.359-.065.372-.57.021-.657l-35.466-9.278a3.328 3.328 0 0 0-1.324-.06l-47.25 5.526c-.804.126-.96 1.215-.22 1.561L38.59 92.1c.406.19.865.251 1.31.169v.004Z", clipRule: "evenodd" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color8)", d: "m30.18 44.09 62.95-4.82 8.05 37.76c.08.39.09.77.03 1.13-.06.36-.19.68-.37.96-.18.28-.42.52-.7.69-.28.17-.61.29-.97.33l-58.03 5.93c-.39.04-.78 0-1.14-.12-.36-.12-.71-.3-1.02-.54a3.51 3.51 0 0 1-.79-.88c-.22-.34-.36-.72-.44-1.13l-7.57-39.31Z" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color9)", d: "M84.24 60.04c.17-.01.33 0 .49.06.16.06.31.14.44.24.13.1.25.24.34.39.09.15.16.32.2.49l.9 4.31a1.258 1.258 0 0 1-.16.95 1.09 1.09 0 0 1-.78.46l-36.31 3.38c-.17.02-.35 0-.51-.06-.16-.06-.32-.14-.46-.25-.14-.11-.26-.24-.35-.4a1.75 1.75 0 0 1-.2-.51l-.87-4.42a1.3 1.3 0 0 1 0-.52c.03-.16.1-.31.19-.44s.21-.24.35-.32c.14-.08.3-.13.47-.15l36.26-3.22v.01Z" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color8)", d: "m61.89 64.02.16 1.1.81-.49.41.77-.89.33.88.8-.6.54-.76-.96-.37 1.07-.82-.43.56-.92-1.01-.16.11-.81 1 .33-.3-1.09.82-.08Zm10.36-.93.16 1.09.8-.49.41.77-.89.32.87.8-.58.54-.77-.95-.35 1.05-.8-.42.54-.92-.99-.15.1-.81.98.33-.29-1.09.81-.07Z" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color9)", d: "M81.91 48.86c.17-.01.33 0 .49.06.16.06.31.14.44.25a1.592 1.592 0 0 1 .54.88l.9 4.28c.04.18.04.35.01.51-.03.16-.09.31-.17.43-.08.12-.19.23-.33.31-.14.08-.28.13-.45.14l-36.23 3.12c-.17.02-.35 0-.51-.06-.16-.06-.32-.14-.46-.25-.14-.11-.26-.24-.35-.4-.09-.16-.16-.32-.2-.5l-.86-4.38a1.3 1.3 0 0 1 0-.52 1.156 1.156 0 0 1 .53-.76c.13-.08.3-.13.47-.14l36.18-2.96v-.01Z" }),
...
//# sourceMappingURL=Small-Y6JXV6PB-RXAIRHG7.js.map

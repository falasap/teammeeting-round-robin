...
// node_modules/@sap-ui/fx-components/dist/Small-NYCDN7SM.js
...
var Small = ({ className }) => (0, import_jsx_runtime.jsxs)("svg", { xmlns: "http://www.w3.org/2000/svg", width: "128", height: "128", fill: "none", viewBox: "0 0 128 128", className, children: [
  ...
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color21)", fillRule: "evenodd", d: "m44.201 92.876 58.057-10.367c.362-.065.375-.575.022-.662l-36.405-9.069a3.352 3.352 0 0 0-1.333-.06l-45.84 7.064c-.81.127-.966 1.224-.221 1.573L42.88 92.7c.41.192.871.253 1.32.17v.005Z", clipRule: "evenodd" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color8)", d: "m28.224 41.167 67.099-4.036 8.622 37.496c.059.252.067.5.04.729a1.63 1.63 0 0 1-.213.63 1.461 1.461 0 0 1-.426.462 1.351 1.351 0 0 1-.599.224l-64.876 8.13a2.073 2.073 0 0 1-1.518-.426 2.278 2.278 0 0 1-.544-.602 2.15 2.15 0 0 1-.295-.78l-7.29-41.827Z" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color13)", d: "M92.308 31.002c.22-.012.441.028.65.103.21.074.41.193.592.342a2.208 2.208 0 0 1 .745 1.19l1.033 4.49-67.103 4.04-.868-4.99a1.76 1.76 0 0 1 .024-.75 1.615 1.615 0 0 1 .86-1.064c.216-.106.46-.173.729-.188l63.338-3.173Z" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color14)", d: "M37.871 84.799a2.038 2.038 0 0 1-.804-.064 2.144 2.144 0 0 1-.714-.362 2.278 2.278 0 0 1-.544-.603 2.125 2.125 0 0 1-.296-.78l-7.29-41.824-.867-4.989a1.73 1.73 0 0 1 .02-.73 1.676 1.676 0 0 1 .292-.618l-1.1 1.43a1.974 1.974 0 0 0-.178.288 1.745 1.745 0 0 0-.162.674c0 .123.005.245.028.37l.856 4.935 7.163 41.366a2.18 2.18 0 0 0 .828 1.368c.213.161.45.283.706.358.256.075.524.099.796.063l64.292-8.122 1.849-.891-64.875 8.13Z" }),
  ...
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color15)", fillRule: "evenodd", d: "M64.459 42.59c2.894-.094 5.645 2.262 6.254 5.431.637 3.3-1.285 6.239-4.3 6.568-.038 0-.07.005-.109.01h-.072c-2.965.22-5.843-2.174-6.463-5.425-.643-3.317 1.313-6.26 4.338-6.568.022 0 .05 0 .072-.005.093-.006.186-.017.28-.017v.005Z", clipRule: "evenodd" }),
  ...
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color14)", fillRule: "evenodd", d: "M68.918 63.304c2.713.126 5.195 2.372 5.772 5.37l-.006-.005c.291 1.5.05 2.933-.582 4.086-.758 1.373-2.07 2.345-3.707 2.548-.06.006-.115.017-.176.017h-.049c-.038.006-.066.005-.088.005h-.637c-.033-.005-.06-.005-.087-.005h-.056c-.033-.005-.06-.011-.093-.011h-.044c-.033 0-.066-.011-.099-.011h-.038c-.039-.005-.072-.011-.11-.017-.071-.01-.11-.022-.154-.027-2.405-.478-4.486-2.565-5.008-5.278-.571-2.976.928-5.672 3.421-6.452.291-.088.593-.154.912-.192.05 0 .093-.012.137-.012.12-.01.242-.016.362-.016.11-.006.22 0 .33 0Z", clipRule: "evenodd" }),
  ...
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color13)", fillRule: "evenodd", d: "M51.457 65.281c2.872-.016 5.557 2.301 6.156 5.426.642 3.334-1.324 6.343-4.399 6.722-.06.005-.12.016-.186.022-.05 0-.094.005-.144.01-2.97.182-5.815-2.18-6.441-5.42-.643-3.355 1.345-6.364 4.437-6.721l.143-.017c.143-.01.286-.016.423-.022h.01Z", clipRule: "evenodd" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color20)", d: "m69.905 52.458 13.027 9.649a4.695 4.695 0 0 0-1.088.972l-12.9-9.55a4.88 4.88 0 0 0 .967-1.076l-.006.005Z" }),

...
// node_modules/@sap-ui/fx-components/dist/Large-DE4NFNBR.js
...
var Large = ({ className }) => (0, import_jsx_runtime.jsxs)("svg", { xmlns: "http://www.w3.org/2000/svg", width: "320", height: "240", fill: "none", viewBox: "0 0 320 240", className, children: [
  ...
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color31)", d: "M143.788 148.642c-.1.05-.12.72-.13.84-.03.28-.05.57-.06.86-.03.61 0 1.23.11 1.83.4 2.19 2.46 4.16 4.69 4.39.29.03.58.03.88 0 .9-.06 1.8-.31 2.69-.48 2.42-.46 4.82-1.21 6.85-2.64 1.06-.75 1.87-1.66 2.71-2.65 1.01-1.2 2.13-2.32 3.15-3.52.79-.94 1.52-1.95 1.69-3.21.42-3.14-3.34-5.05-6.04-4.64-1.84.28-3.17 1.61-4.56 2.71-1.2.96-2.37 1.95-3.51 2.97-.44.4-.76.88-1.34.91-.34.02-.71-.06-1.06-.09l-1.14-.04-4.9 2.75-.03.01Z", opacity: ".9" }),
  ...
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color31)", d: "m133.647 139.484.02 2.23c0 .73.33 1.55.6 2.2a8.383 8.383 0 0 0 2.17 3.09c.33.3.69.56 1.07.79.85.52 1.83.88 2.83.98 1.12.11 2.23-.14 3.33-.36.93-.19 1.86-.35 2.77-.62 1.17-.34 2.51-.85 3.22-1.9.58-.86.54-2.04.21-2.99-.39-1.15-1.25-2.15-2.35-2.67-1.11-.52-2.38-.51-3.55-.27-.96.2-1.89.55-2.84.8-1.36.36-2.72.45-4.02-.19-.45-.22-.97-.37-1.44-.56-.66-.26-1.39-.42-2.05-.68l.07.14-.04.01Z", opacity: ".9" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color8)", d: "M144.058 142.273s3.56 3.76 3.56 3.77c-.03-.03-1.37.59-1.51.64-1.33.45-3.2.5-4.33-.46-.92-.79-1.39-2.31-.24-3.13.37-.26.79-.38 1.2-.55.2-.08 1.12-.48 1.32-.27Z", opacity: ".9" }),
  ...
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color9)", fillRule: "evenodd", d: "M22.668 58.953c2.46 8.92 4.37 15.56 4.71 15.76 2.87 1.62-.78 3.21 2.09 4.83 4.16 2.35 2.53 7.33 6.69 9.68 4.96 2.79 2.41 1.15 15.79 9.63 5.24 2.95 10.48 5.91 15.73 8.86 5.24 2.95 10.05 5.66 15.07 8.49 4.3 2.43 8.61 4.85 12.91 7.27 3.08 1.74 6.16 3.47 9.24 5.21 2.79 1.57 5.51 3.24 8.33 4.75l8.08-1.52c2.74-2.42 5.05-5.33 7.22-8.25 4.26-5.77 7.98-11.97 11.19-18.39l-44.25-46.32h-72.8Z", clipRule: "evenodd" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color14)", d: "M208.778 133.703c-.3.92-1.1 1.56-1.86 1.51-.82-.06-1.4-.9-1.23-1.98.19-1.22 1.21-2.11 2.18-1.87.88.23 1.24 1.32.91 2.34Z", opacity: ".9" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color17)", d: "M99.628 120.554c-2.04-.17-3.7-1.87-3.71-3.82 0-1.94 1.65-3.38 3.7-3.22 2.04.17 3.7 1.87 3.71 3.82 0 1.94-1.65 3.38-3.7 3.22Zm12.689 8.238c-2.04-.17-3.7-1.87-3.71-3.82 0-1.94 1.65-3.38 3.7-3.22 2.04.17 3.7 1.87 3.71 3.82 0 1.94-1.65 3.38-3.7 3.22Z", opacity: ".9" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color3)", fillRule: "evenodd", d: "M200.398 135.563s-.49 1.32-.89 1.45c-.55.16-1.08-1.01-1.08-1.01l1.81-.48.17.05-.01-.01Z", clipRule: "evenodd", opacity: ".9" })
] });
var Large_default = Large;
export {
  Large_default as default
};
//# sourceMappingURL=Large-DE4NFNBR-6OLMA3QQ.js.map

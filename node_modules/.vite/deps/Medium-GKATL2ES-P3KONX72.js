...
// node_modules/@sap-ui/fx-components/dist/Medium-GKATL2ES.js
...
var Medium = ({ className }) => (0, import_jsx_runtime.jsxs)("svg", { xmlns: "http://www.w3.org/2000/svg", width: "160", height: "160", fill: "none", viewBox: "0 0 160 160", className, children: [
  ...
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color21)", fillRule: "evenodd", d: "m53.513 115.143 74.259-13.259c.462-.084.479-.736.028-.847l-46.564-11.6a4.287 4.287 0 0 0-1.705-.078l-58.632 9.037c-1.036.162-1.237 1.565-.284 2.011l31.21 14.513a2.79 2.79 0 0 0 1.688.217v.006Z", clipRule: "evenodd" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color8)", d: "m33.077 49.003 85.825-5.162 11.028 47.96c.076.323.086.64.051.933-.036.292-.131.57-.273.806a1.846 1.846 0 0 1-.544.59 1.722 1.722 0 0 1-.767.287l-82.98 10.4a2.652 2.652 0 0 1-1.942-.545 2.894 2.894 0 0 1-.695-.771 2.747 2.747 0 0 1-.379-.998l-9.324-53.5Z" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color13)", d: "M115.044 36.003c.282-.016.565.035.832.13.267.096.525.248.757.44a2.835 2.835 0 0 1 .953 1.522l1.321 5.741-85.83 5.167-1.109-6.382c-.06-.337-.045-.66.03-.957a2.065 2.065 0 0 1 1.1-1.361 2.43 2.43 0 0 1 .933-.242l81.013-4.058ZM38.383 46.21c.272-.015.524-.086.74-.197a1.66 1.66 0 0 0 .55-.454 1.725 1.725 0 0 0 .333-1.401 2.07 2.07 0 0 0-.287-.746 2.317 2.317 0 0 0-1.23-.978 2.121 2.121 0 0 0-.797-.111c-.273.015-.52.08-.742.192a1.679 1.679 0 0 0-.867 1.093c-.055.237-.07.5-.02.767a2.19 2.19 0 0 0 .822 1.346c.212.166.449.297.7.383.253.085.525.126.797.11" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color14)", d: "M45.416 104.811c-.353.046-.701.01-1.029-.08a2.742 2.742 0 0 1-.913-.464 2.923 2.923 0 0 1-.695-.771 2.722 2.722 0 0 1-.379-.998l-9.324-53.495-1.11-6.382a2.206 2.206 0 0 1-.035-.479c0-.156.026-.307.06-.454a2.159 2.159 0 0 1 .373-.791l-1.406 1.83a2.49 2.49 0 0 0-.227.368 2.19 2.19 0 0 0-.172 1.336l1.095 6.311 9.163 52.91c.06.358.191.691.373.988a2.778 2.778 0 0 0 1.588 1.22 2.48 2.48 0 0 0 1.02.081l82.233-10.39 2.365-1.14-82.98 10.4Z" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color2)", d: "M37.69 42.319c.272-.016.54.025.796.11a2.317 2.317 0 0 1 1.23.978c.142.227.243.48.288.746a1.727 1.727 0 0 1-.333 1.401 1.658 1.658 0 0 1-.55.454 1.842 1.842 0 0 1-.74.197 2.135 2.135 0 0 1-.797-.11 2.26 2.26 0 0 1-.701-.384 2.407 2.407 0 0 1-.535-.595 2.06 2.06 0 0 1-.287-.75 1.94 1.94 0 0 1 .02-.767c.055-.237.166-.459.313-.64a1.719 1.719 0 0 1 1.296-.645v.005Z" }),
  ...
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color13)", fillRule: "evenodd", d: "M63.685 79.579c3.526-.02 6.824 2.825 7.56 6.662.788 4.093-1.626 7.789-5.402 8.254-.074.007-.149.02-.23.027-.06 0-.115.007-.175.013-3.648.223-7.141-2.676-7.91-6.655-.789-4.12 1.652-7.816 5.449-8.254l.175-.02c.175-.014.351-.02.52-.027h.013Z", clipRule: "evenodd" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color20)", d: "m86.341 63.833 15.996 11.848a5.78 5.78 0 0 0-1.336 1.194l-15.84-11.727a5.993 5.993 0 0 0 1.187-1.322l-.007.007Z" }),

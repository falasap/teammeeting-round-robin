...
// node_modules/@sap-ui/fx-components/dist/Large-A2DF7GK6.js
...
var Large = ({ className }) => (0, import_jsx_runtime.jsxs)("svg", { xmlns: "http://www.w3.org/2000/svg", width: "320", height: "240", fill: "none", viewBox: "0 0 320 240", className, children: [
  ...
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color29)", d: "M132.199 102.91s2.78-2.43 4.83-2.43c2.05 0 4.8 1.04 7.01 1.64 2.21.6 4.61 1.11 5.12.79.51-.32.32-2.18.28-2.43-.04-.25-.98-.88-2.97-1.11-1.99-.23-4.08-.32-7.05-.19-2.97.13-6.28 1.17-7.23 3.73h.01Zm43.87 0s-2.78-2.43-4.83-2.43c-2.05 0-4.8 1.04-7.01 1.64-2.21.6-4.61 1.11-5.12.79-.51-.32-.32-2.18-.28-2.43.04-.25.98-.88 2.97-1.11 1.99-.23 4.08-.32 7.05-.19 2.97.13 6.28 1.17 7.23 3.73h-.01Zm-24.148 21.909c-.02-.54-.95-1.33-1.9-1.3-.95.03-1.71.76-1.71 1.42 0 .66.95.85 1.63.76.68-.09 1.99-.36 1.97-.88h.01Zm3.949.471c.11.46 1.14.54 1.8.43.66-.11 1.09-.43 1.09-1.1 0-.67-.36-.91-1.11-.86-.75.05-1.94.85-1.78 1.54v-.01Z" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color1)", d: "M154.07 140.85c1.77 0 3.38-.09 5.15-1.39 1.77-1.3 4.49-3.85 4.52-4.23.03-.38-2.31-1.11-3.79-1.99-1.48-.88-2.24-1.42-3.76-1.39-1.52.03-2.12.66-2.12.66s-.73-.66-2.15-.66-3.35.95-4.36 1.8c-1.01.85-1.77 1.39-3.16 1.71 0 0 3.01 3.25 5.47 4.36 2.46 1.11 2.78 1.14 4.2 1.14v-.01Z" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color11)", d: "M154.07 140.85c-1.42 0-1.74-.03-4.2-1.14-1.55-.69-3.31-2.24-4.4-3.29.2-.2.39-.34.51-.38 0 0 .41-.38 3.29-.41 2.87-.03 6.35 0 7.84 0 3.35 0 4.9 1.07 4.9 1.07l.26.16c-.93.88-2.11 1.91-3.04 2.59-1.77 1.3-3.38 1.39-5.15 1.39h-.01v.01Z" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color29)", d: "M146.75 110.86c-.37-.02-2.26-1.23-2.48-1.02-.2 1.64-2.01 3.04-3.6 2.1-.87-.51-1.15-1.31-1.55-2.17-1.19.43-2.7 1.2-3.85.28-.24-.193-.354-.383-.34-.57.55-.95 1.81-1.46 2.83-1.73 2.51-.67 5.54-.53 7.6 1.04.62.47 1.39 1.25 1.39 2.07Zm21.651-1.09c-.44 1.88-2.26 3.35-4.05 1.89-.59-.48-.98-1.14-1.06-1.9l-2.48 1.09c.04-.96 1.18-1.99 1.95-2.47 2.36-1.46 7.52-1.43 9.55.57.51.51.49.79-.13 1.18-1.29.81-2.51-.02-3.77-.38l-.01.02Z" }),
  ...
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color28)", d: "M158.695 118.856c1.747.687 3.964 4.459 3.585 6.253-.377 1.786-2.615 1.426-2.65 1.42.027-.013 1.987-.989 1.709-2.37-.697-3.01-2.528-5.168-2.644-5.303Zm-34.973-4.213c.29-.6.62-.81 1.16-.32v.01c-.012.01-.706.6-.29 6-.003-.011-1.349-4.691-.87-5.69Zm58.728-1.032c.54-.49.869-.28 1.159.32.479.997-.862 5.667-.869 5.69.415-5.383-.273-5.986-.29-6v-.01Zm-23.755 5.245-.016-.006h.011l.005.006Z" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color8)", d: "M218.319 113.55v3H89.609v-3h128.71Z" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color20)", d: "M155.763 182.492c.051.033.816.53.787 1.448-.023.728-.563 15.9-.819 23.06h-2.347c.482-6.932 1.579-22.702 1.626-23.439.056-.883.677-1.052.753-1.069Zm-9.253-2.093c3.303 2.019 6.177 3.058 6.37 3.126l-17.08 10.714c-3.03-4.35-3.029-6.45-3.029-6.45l13.739-7.39Zm18.68-2.83c.077.031 15.609 6.209 15.88 5.891.27-.32-1.96 4.648-2.31 5.119-.35.469-19.962-5.821-20.02-5.84l6.45-5.179v.009Zm-12.3 5.96-.01-.004.01-.005v.009Zm2.873-1.037-.003-.002h.011l-.008.002Z" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color14)", d: "M211.818 198.04s1.05 3.686 2.494 8.96h-.863c-.37-2.906-.9-5.907-1.631-8.96Z" })
] });
var Large_default = Large;
export {
  Large_default as default
};
//# sourceMappingURL=Large-A2DF7GK6-JMUCCXCU.js.map

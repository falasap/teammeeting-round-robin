...
// node_modules/@sap-ui/fx-components/dist/Medium-OMOOXQBC.js
...
var Medium = ({ className }) => (0, import_jsx_runtime.jsxs)("svg", { xmlns: "http://www.w3.org/2000/svg", width: "160", height: "160", fill: "none", viewBox: "0 0 160 160", className, children: [
  ...
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color21)", fillRule: "evenodd", d: "m54.034 115.439 75.413-13.466c.469-.084.486-.746.028-.86l-47.288-11.78a4.354 4.354 0 0 0-1.731-.078l-59.543 9.177c-1.053.164-1.256 1.589-.289 2.042l31.695 14.739a2.83 2.83 0 0 0 1.715.22v.006Z", clipRule: "evenodd" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color2)", d: "M37.929 42.303c.271-.015.538.025.794.11a2.31 2.31 0 0 1 1.228.976c.14.226.241.478.287.744a1.72 1.72 0 0 1-.332 1.398 1.656 1.656 0 0 1-.549.453 1.85 1.85 0 0 1-.74.196 2.131 2.131 0 0 1-.794-.11 2.252 2.252 0 0 1-.7-.383 2.402 2.402 0 0 1-.532-.593 2.056 2.056 0 0 1-.287-.75 1.938 1.938 0 0 1 .02-.764c.055-.236.166-.457.312-.639a1.714 1.714 0 0 1 1.293-.644v.006Z" }),

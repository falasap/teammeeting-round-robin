...
var ExtraSmall = ({ className }) => (0, import_jsx_runtime.jsxs)("svg", { xmlns: "http://www.w3.org/2000/svg", width: "46", height: "46", fill: "none", viewBox: "0 0 46 46", className, children: [
  (0, import_jsx_runtime.jsxs)("g", { clipPath: "url(#a)", children: [
    ...
    (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color29)", d: "M15.39 21.66s.972-.85 1.689-.85c.717 0 1.678.364 2.45.574.773.21 1.613.388 1.79.276.18-.112.113-.762.099-.85-.014-.087-.343-.307-1.039-.388-.695-.08-1.426-.112-2.465-.066-1.038.045-2.195.409-2.527 1.304h.003Zm15.339 0s-.972-.85-1.689-.85c-.716 0-1.678.364-2.45.574-.773.21-1.612.388-1.79.276-.179-.112-.113-.762-.099-.85.014-.087.343-.307 1.039-.388.696-.08 1.426-.112 2.465-.066 1.038.045 2.195.409 2.527 1.304h-.003Zm-8.443 7.662c-.007-.189-.333-.465-.665-.454-.332.01-.598.265-.598.496 0 .23.333.297.57.266.238-.032.696-.126.69-.308h.003Zm1.38.163c.039.161.399.19.63.15.23-.038.38-.15.38-.384s-.125-.318-.387-.3c-.263.017-.679.297-.623.538v-.004Z" }),
    (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color1)", d: "M23.037 34.926c.619 0 1.182-.031 1.8-.486.62-.454 1.57-1.346 1.581-1.479.01-.132-.808-.388-1.325-.695-.517-.308-.783-.497-1.315-.486-.531.01-.74.23-.74.23s-.256-.23-.753-.23c-.496 0-1.17.332-1.524.629-.353.297-.619.486-1.105.598 0 0 1.053 1.136 1.913 1.524.86.388.972.399 1.468.399v-.004Z" }),
    (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color11)", d: "M23.037 34.925c-.496 0-.608-.01-1.468-.398-.542-.241-1.158-.783-1.539-1.15a.569.569 0 0 1 .179-.133s.143-.133 1.15-.144c1.003-.01 2.22 0 2.74 0 1.172 0 1.714.374 1.714.374l.09.056c-.324.308-.737.668-1.062.906-.619.454-1.182.486-1.8.486h-.004v.003Z" }),
    (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color29)", d: "M20.478 24.44c-.13-.006-.79-.43-.867-.356-.07.574-.703 1.063-1.26.734-.303-.178-.401-.458-.541-.758-.416.15-.944.42-1.346.098-.084-.068-.124-.134-.119-.2.192-.332.633-.51.99-.604.877-.235 1.936-.186 2.657.363.216.164.486.437.486.724Zm7.569-.382c-.154.657-.79 1.172-1.416.661a.986.986 0 0 1-.37-.664l-.867.38c.014-.335.412-.695.681-.863.825-.51 2.63-.5 3.34.2.178.178.17.276-.046.412-.451.283-.878-.007-1.318-.133l-.004.007Z" }),
    (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color24)", d: "M3.636 39.245v-5.626h1.049v5.626c0 1.291.992 2.3 2.143 2.3h6.786v1.049H6.828c-1.787 0-3.192-1.537-3.192-3.35Zm0-27.293c0-1.817 1.406-3.35 3.192-3.35h7.045v1.05H6.828c-1.151 0-2.143 1.005-2.143 2.3v6.24h-1.05v-6.24Zm38.476 0c0-1.292-.993-2.3-2.144-2.3h-6.555v-1.05h6.556c1.786 0 3.191 1.537 3.191 3.35v6.318h-1.048v-6.318Zm0 27.293v-5.433h1.05v5.433c0 1.817-1.407 3.35-3.193 3.35h-6.44v-1.05h6.44c1.151 0 2.143-1.006 2.143-2.3Z" }),
    (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color28)", d: "M24.654 27.238c.61.24 1.386 1.558 1.253 2.186-.131.624-.914.498-.926.496.01-.005.695-.346.597-.828a4.736 4.736 0 0 0-.924-1.854Zm-12.227-1.474c.101-.21.216-.283.405-.111v.003c-.004.004-.247.21-.101 2.098-.001-.004-.472-1.64-.304-1.99Zm20.533-.36c.188-.171.303-.098.404.111.168.35-.301 1.982-.303 1.99.145-1.882-.096-2.093-.102-2.098v-.003Zm-8.306 1.834-.006-.003h.004l.002.003Z" }),
    (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color24)", d: "M45.5 25.386v1.049H.5v-1.05h45Z" })
  ] }),
  (0, import_jsx_runtime.jsx)("defs", { children: (0, import_jsx_runtime.jsx)("clipPath", { id: "a", children: (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color8)", d: "M.5.5h45v45H.5z" }) }) })
] });
var ExtraSmall_default = ExtraSmall;
export {
  ExtraSmall_default as default
};
//# sourceMappingURL=ExtraSmall-C6BTJQZ6-SHX5BJUL.js.map

...
// node_modules/@sap-ui/fx-components/dist/Large-IVQSWKK5.js
...
var Large = ({ className }) => (0, import_jsx_runtime.jsxs)("svg", { xmlns: "http://www.w3.org/2000/svg", width: "320", height: "240", fill: "none", viewBox: "0 0 320 240", className, children: [
  ...
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color21)", fillRule: "evenodd", d: "m81.117 185.969 133.735-23.88c.833-.15.863-1.324.051-1.525l-83.86-20.889a7.728 7.728 0 0 0-3.07-.141L22.381 155.808c-1.867.291-2.228 2.82-.512 3.623l56.207 26.137a5.026 5.026 0 0 0 3.04.391v.01Z", clipRule: "evenodd" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color13)", d: "M219.46 38a4.027 4.027 0 0 1 1.57.247c.504.181.989.466 1.427.828a5.331 5.331 0 0 1 1.798 2.872l2.493 10.833-161.934 9.748-2.093-12.04a4.251 4.251 0 0 1 .057-1.807c.143-.561.4-1.075.752-1.512a3.88 3.88 0 0 1 1.322-1.056 4.58 4.58 0 0 1 1.76-.457L219.46 38Z" }),
  ...
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color9)", d: "M172.869 121.267c.466-.048.932 0 1.379.152a3.93 3.93 0 0 1 1.237.675c.371.305.704.666.971 1.084.266.419.456.885.561 1.389l1.903 9.159c.104.504.114 1.008.028 1.465a3.513 3.513 0 0 1-.485 1.255 3.104 3.104 0 0 1-.913.913c-.362.238-.799.39-1.266.438l-77.066 8.711a3.9 3.9 0 0 1-1.522-.142 4.176 4.176 0 0 1-1.351-.704 4.105 4.105 0 0 1-1.028-1.151 4.374 4.374 0 0 1-.57-1.484l-1.742-9.691a3.759 3.759 0 0 1 .029-1.531c.114-.485.304-.923.59-1.313.285-.39.628-.704 1.046-.951a3.327 3.327 0 0 1 1.408-.447l76.791-7.846v.019Z" }),
  ...
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color9)", d: "M168.683 101.018a3.5 3.5 0 0 1 1.37.162 4.16 4.16 0 0 1 2.198 1.759c.256.419.456.885.561 1.38l1.884 9.035c.104.504.104.989.028 1.436a3.224 3.224 0 0 1-.485 1.227 2.894 2.894 0 0 1-.913.884c-.362.219-.79.371-1.266.419l-76.723 7.637c-.514.047-1.028 0-1.513-.152a4.21 4.21 0 0 1-1.342-.704 4.543 4.543 0 0 1-1.027-1.141 4.085 4.085 0 0 1-.562-1.465l-1.712-9.549a3.833 3.833 0 0 1 .028-1.512 3.354 3.354 0 0 1 1.618-2.207c.409-.237.885-.38 1.398-.428l76.448-6.8.01.019Z" }),
  ...
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color2)", d: "M73.52 49.917a4.027 4.027 0 0 1 1.503.21c.485.16.923.408 1.322.722.4.314.733.694 1 1.122.266.428.456.904.542 1.408.085.504.076.989-.038 1.436a3.255 3.255 0 0 1-.59 1.208 3.131 3.131 0 0 1-1.037.856c-.41.21-.885.342-1.399.37a4.03 4.03 0 0 1-1.503-.209 4.257 4.257 0 0 1-1.323-.722 4.543 4.543 0 0 1-1.008-1.122 3.886 3.886 0 0 1-.543-1.418 3.664 3.664 0 0 1 .039-1.445 3.05 3.05 0 0 1 .59-1.208 3.309 3.309 0 0 1 1.046-.856 3.241 3.241 0 0 1 1.399-.361v.009Z" }),
...
//# sourceMappingURL=Large-IVQSWKK5-PRXQNRQ2.js.map

...
// node_modules/@sap-ui/fx-components/dist/Medium-5N5WN2MY.js
...
var Medium = ({ className }) => (0, import_jsx_runtime.jsxs)("svg", { width: "160", height: "160", viewBox: "0 0 160 160", fill: "none", xmlns: "http://www.w3.org/2000/svg", className, children: [
  ...
  (0, import_jsx_runtime.jsx)("path", { d: "M70.2578 43.5483L70.5264 81.5603C70.5405 83.4498 72.0814 84.9671 73.9709 84.9577L89.1908 84.8493C91.0803 84.8351 92.5976 83.2943 92.5835 81.4048L92.3149 43.3928C92.3007 41.5079 90.7599 39.986 88.8751 40.0001L73.6552 40.1085C71.7657 40.1226 70.2484 41.6634 70.2625 43.553L70.2578 43.5483Z", fill: "var(--sapContent_Illustrative_Color11)" }),
  (0, import_jsx_runtime.jsx)("path", { d: "M88.889 40.7914L85.2984 40.815L85.3126 42.8553C85.3126 43.3406 84.9262 43.7317 84.4408 43.7411L78.155 43.7835C77.6696 43.7835 77.2785 43.3971 77.2691 42.9118L77.255 40.8715L73.6644 40.8951C72.2131 40.9045 71.0492 42.0872 71.0587 43.5385L71.3272 81.5552C71.3367 83.0065 72.5194 84.1704 73.9707 84.161L89.1953 84.0526C90.6466 84.0432 91.8105 82.8605 91.801 81.4092L91.5325 43.3924C91.523 41.9411 90.3403 40.7773 88.889 40.7867V40.7914Z", fill: "var(--sapContent_Illustrative_Color8)" }),
  (0, import_jsx_runtime.jsx)("path", { d: "M82.3342 42.4119L79.3844 42.4307C79.1724 42.4307 78.998 42.2705 78.998 42.0726C78.998 41.8747 79.1724 41.7098 79.3844 41.7098L82.3342 41.6909C82.5462 41.6909 82.7206 41.8511 82.7206 42.049C82.7206 42.2469 82.5462 42.4119 82.3342 42.4119Z", fill: "var(--sapContent_Illustrative_Color22)" }),
  (0, import_jsx_runtime.jsx)("path", { d: "M83.626 42.3932C83.8191 42.3743 83.9605 42.2047 83.9464 42.0162C83.9322 41.8277 83.7579 41.6816 83.5694 41.6958C83.3809 41.7099 83.2349 41.8843 83.249 42.0727C83.2631 42.2612 83.4375 42.4073 83.626 42.3932Z", fill: "var(--sapContent_Illustrative_Color22)" }),
  (0, import_jsx_runtime.jsx)("path", { d: "M69.3577 51.0512L69.3766 54.6794C69.3766 55.014 69.1551 55.0611 69.2352 55.0988L69.4049 55.1648C69.7583 55.1553 70.0504 55.1553 70.0646 54.7313L70.074 50.8438C70.0504 50.4574 69.7441 50.3114 69.386 50.3444L69.3342 50.4622C69.0892 50.5046 69.3577 50.7213 69.353 51.0559L69.3577 51.0512Z", fill: "var(--sapContent_Illustrative_Color11)" }),
  (0, import_jsx_runtime.jsx)("path", { d: "M69.0656 50.927L69.042 54.6543C69.042 54.9181 69.0608 55.0972 69.3059 55.149C69.5697 55.149 69.7912 55.1726 69.7912 54.9087L69.7818 50.7998C69.7818 50.5359 69.6546 50.3333 69.3907 50.3286C69.1315 50.3522 69.0656 50.6537 69.0703 50.9176L69.0656 50.927Z", fill: "var(--sapContent_Illustrative_Color1)" }),
  (0, import_jsx_runtime.jsx)("path", { d: "M88.1254 56.3228C87.904 56.1249 87.6165 56.0259 87.3197 56.0448C87.0228 56.0636 86.7354 56.205 86.5422 56.4311L79.361 64.7385L76.8307 61.5296C76.6469 61.294 76.383 61.1432 76.0862 61.1102C75.7893 61.0772 75.4972 61.1573 75.2616 61.3411C75.026 61.5249 74.8752 61.7887 74.8422 62.0856C74.8092 62.3824 74.8893 62.6746 75.0778 62.9102L78.4563 67.1934C78.6731 67.462 78.9841 67.6175 79.3092 67.6175H79.3281C79.6485 67.6175 79.9548 67.4762 80.1668 67.2311L88.2338 57.8966C88.4317 57.6751 88.5307 57.3877 88.5118 57.0908C88.493 56.794 88.3516 56.5112 88.1301 56.3181L88.1254 56.3228Z", fill: "var(--sapContent_Illustrative_Color9)" }),
  (0, import_jsx_runtime.jsx)("path", { d: "M66.7238 76.9178C66.9406 77.5021 67.1149 78.4068 67.2893 79.4529C67.2893 79.4529 69.5558 79.4717 69.6406 79.4764V78.4916C72.5149 78.0628 71.6856 76.2534 71.2757 75.1791C70.8704 74.1047 69.6076 72.4744 69.6076 72.4744L69.6217 71.188C71.2851 71.0278 71.3275 69.5623 70.9977 68.8178C70.7809 68.3325 69.8102 67.1073 69.1694 66.6974C68.5286 66.2874 67.8076 66.5513 66.9076 67.1639C66.0076 67.7765 65.9793 68.4974 66.328 69.7744C66.6767 71.0513 67.9537 72.3 67.9537 72.3C67.9537 72.3 66.9971 72.5026 66.1537 73.2C65.3102 73.8974 66.2197 75.5419 66.7286 76.9131L66.7238 76.9178Z", fill: "var(--sapContent_Illustrative_Color31)" }),
  (0, import_jsx_runtime.jsx)("path", { d: "M68.7262 75.109C68.123 75.7122 68.6461 76.9138 68.9665 77.498L69.2304 77.8986C69.2304 77.8986 70.1869 78.1106 71.1717 76.9703C71.1717 76.9703 70.7429 75.3069 69.9749 74.9535C69.3293 74.6567 68.9665 74.8734 68.7262 75.1138V75.109Z", fill: "var(--sapContent_Illustrative_Color11)" }),
  (0, import_jsx_runtime.jsx)("path", { d: "M68.2074 70.1992C68.2074 70.1992 68.2828 68.484 70.3985 68.9599V68.8044C70.3985 68.8044 69.7106 67.4096 68.476 67.6028C67.2414 67.796 67.4865 68.9646 67.6655 69.384C67.8446 69.8034 68.0378 70.1992 68.0378 70.1992H68.2121H68.2074Z", fill: "var(--sapContent_Illustrative_Color11)" }),
  (0, import_jsx_runtime.jsx)("path", { d: "M66.1867 57.0236C66.1867 57.0236 66.4788 55.4026 68.4956 55.9728H68.7406C68.7406 55.9728 67.9678 55.1529 67.0725 55.3838C66.1773 55.6147 66.0736 56.4298 66.1867 57.0236Z", fill: "var(--sapContent_Illustrative_Color11)" }),
  (0, import_jsx_runtime.jsx)("path", { d: "M66.2051 58.0526C66.2051 58.0526 66.714 59.7348 68.0192 59.7348C69.1313 59.7348 69.5365 57.506 69.0276 56.1489C69.0276 56.1489 69.1501 56.229 69.3056 56.3468C69.4611 56.4646 69.5412 56.5494 69.5412 56.5494L69.5695 63.5138C69.5695 63.5138 66.5066 60.2672 66.2051 58.0573V58.0526Z", fill: "var(--sapContent_Illustrative_Color3)" }),
  (0, import_jsx_runtime.jsx)("path", { d: "M69.6215 71.1936C69.6215 71.1936 67.9251 71.3821 67.0299 69.8271C66.1346 68.2722 66.1157 68.4701 66.1157 68.4701C66.1157 68.4701 66.078 68.8659 66.1864 69.3324C66.2948 69.7989 66.6152 71.0711 67.944 72.3057C67.944 72.3057 69.0796 72.0041 69.6026 72.48L69.6168 71.1936H69.6215Z", fill: "var(--sapContent_Illustrative_Color3)" }),
  (0, import_jsx_runtime.jsx)("path", { d: "M69.6359 78.4919C69.6359 78.4919 68.3495 78.7416 66.0029 75.0615C66.0029 75.0615 66.5731 76.4798 66.8322 77.2479C67.0914 78.016 67.4307 80.3673 67.4307 80.3673C67.4307 80.3673 67.8218 83.0579 68.1186 84.349C68.1186 84.349 68.7689 80.994 69.6453 81.2767L69.6359 78.4919Z", fill: "var(--sapContent_Illustrative_Color3)" }),
  ...
  (0, import_jsx_runtime.jsx)("path", { d: "M94.2941 77.7193C94.0773 76.0276 93.4035 74.746 92.9842 72.3428C92.5648 69.9397 93.2198 68.7334 93.2198 68.7334C91.6836 69.4025 91.5423 70.524 91.481 72.814C91.4245 75.1041 92.348 76.9135 92.348 76.9135C92.5836 77.5213 92.5836 78.4119 92.5836 78.4119C92.5836 78.4119 91.9899 81.3334 92.5506 81.9318C93.2198 80.8009 94.2894 77.7193 94.2894 77.7193H94.2941Z", fill: "var(--sapContent_Illustrative_Color3)" }),
  (0, import_jsx_runtime.jsx)("path", { d: "M95.7313 72.7482C95.7313 72.7482 94.7842 72.1215 94.4214 70.9811C94.0585 69.8408 93.9219 68.7571 93.9219 68.6251C93.9219 68.6251 94.459 68.3565 94.7041 68.7052C95.3355 69.6005 95.8774 71.8434 95.7313 72.7482Z", fill: "var(--sapContent_Illustrative_Color11)" }),

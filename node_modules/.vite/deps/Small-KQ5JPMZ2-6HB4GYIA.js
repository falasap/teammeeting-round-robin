...
// node_modules/@sap-ui/fx-components/dist/Small-KQ5JPMZ2.js
...
var Small = ({ className }) => (0, import_jsx_runtime.jsxs)("svg", { xmlns: "http://www.w3.org/2000/svg", width: "128", height: "128", fill: "none", viewBox: "0 0 128 128", className, children: [
  ...
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color21)", fillRule: "evenodd", d: "m32.328 90.787 53.495-9.552c.333-.06.345-.53.02-.61l-33.544-8.356a3.09 3.09 0 0 0-1.228-.056l-42.237 6.51c-.746.116-.89 1.127-.205 1.448l22.483 10.455a2.01 2.01 0 0 0 1.216.157v.004Z", clipRule: "evenodd" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color13)", d: "M87.666 31.6c.213-.012.427.026.628.099.202.072.396.186.571.33a2.134 2.134 0 0 1 .72 1.15l.997 4.333-64.774 3.899-.837-4.816a1.699 1.699 0 0 1 .022-.723 1.557 1.557 0 0 1 .83-1.027c.21-.103.445-.168.704-.183l61.14-3.062Z" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color8)", d: "m25.808 41.411 64.77-3.895L98.9 73.71c.057.243.064.483.038.704a1.56 1.56 0 0 1-.206.608 1.396 1.396 0 0 1-.41.445 1.3 1.3 0 0 1-.58.217L35.12 83.533a2.003 2.003 0 0 1-1.465-.41 2.199 2.199 0 0 1-.525-.583 2.088 2.088 0 0 1-.286-.754l-7.036-40.375Z" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color20)", d: "M81.01 41.82c2.297-.152 4.587 1.576 5.109 3.85l4.843 21.094c.551 2.401-.902 4.617-3.251 4.909L45.769 76.92c-2.78.349-5.445-1.558-5.894-4.22l-3.932-23.33c-.423-2.507 1.466-4.693 4.167-4.87l40.9-2.681Z" }),
...
//# sourceMappingURL=Small-KQ5JPMZ2-6HB4GYIA.js.map

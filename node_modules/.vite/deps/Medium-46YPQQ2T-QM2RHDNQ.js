...
// node_modules/@sap-ui/fx-components/dist/Medium-46YPQQ2T.js
...
var Medium = ({ className }) => (0, import_jsx_runtime.jsxs)("svg", { xmlns: "http://www.w3.org/2000/svg", width: "160", height: "160", fill: "none", viewBox: "0 0 160 160", className, children: [
  (0, import_jsx_runtime.jsx)("rect", { width: "160", height: "69", y: "50.584", fill: "var(--sapContent_Illustrative_Color20)", rx: "12" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color21)", fillRule: "evenodd", d: "m54.034 115.317 75.413-13.466c.47-.085.487-.747.029-.86l-47.289-11.78a4.356 4.356 0 0 0-1.731-.079L20.913 98.31c-1.053.164-1.256 1.59-.289 2.043L52.32 115.09a2.837 2.837 0 0 0 1.714.221v.006Z", clipRule: "evenodd" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color2)", d: "M37.929 42.303a2.13 2.13 0 0 1 .795.11 2.31 2.31 0 0 1 1.227.976c.14.226.241.478.287.744a1.72 1.72 0 0 1-.332 1.398 1.654 1.654 0 0 1-.549.453 1.85 1.85 0 0 1-.74.196 2.13 2.13 0 0 1-.794-.11 2.25 2.25 0 0 1-.7-.383 2.4 2.4 0 0 1-.532-.593 2.055 2.055 0 0 1-.287-.75 1.938 1.938 0 0 1 .02-.764c.055-.236.166-.457.312-.639a1.714 1.714 0 0 1 1.293-.644v.006Z" }),

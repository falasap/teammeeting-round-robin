...
// node_modules/@sap-ui/fx-components/dist/Medium-CONM3C6C.js
...
var Medium = ({ className }) => (0, import_jsx_runtime.jsxs)("svg", { width: "160", height: "160", viewBox: "0 0 160 160", fill: "none", xmlns: "http://www.w3.org/2000/svg", className, children: [
  ...
  (0, import_jsx_runtime.jsx)("path", { d: "M89.3536 53.5168C89.3429 53.5168 89.3429 53.499 89.3536 53.499C89.3643 53.499 89.3643 53.5168 89.3536 53.5168Z", fill: "var(--sapContent_Illustrative_Color3)" }),
  (0, import_jsx_runtime.jsx)("path", { d: "M78.2628 41.4549C78.1967 41.6862 78.2976 41.9332 78.508 42.048C79.1099 42.3716 80.3605 42.843 80.7171 41.4114C81.0998 39.8825 79.9135 39.785 79.4282 39.8059C79.3029 39.8111 79.1864 39.8651 79.1029 39.959C78.889 40.2008 78.4611 40.7487 78.261 41.4549H78.2628Z", fill: "var(--sapContent_Illustrative_Color23)" }),
  (0, import_jsx_runtime.jsx)("path", { d: "M82.107 40.3555C82.0826 40.726 82.3 41.0669 82.641 41.2165C83.215 41.467 84.1421 41.6409 84.4621 40.359C84.7926 39.037 83.9508 38.7848 83.4028 38.7535C83.1332 38.7378 82.8706 38.8439 82.6931 39.0457C82.4548 39.317 82.1452 39.7745 82.107 40.3555Z", fill: "var(--sapContent_Illustrative_Color23)" }),
  (0, import_jsx_runtime.jsx)("path", { d: "M85.3024 43.1839C85.2432 43.4291 85.3702 43.6796 85.5998 43.7874C86.2138 44.0745 87.4401 44.4484 87.6575 43.003C87.9393 41.1261 86.1268 41.5001 86.1268 41.5001C86.1268 41.5001 85.4937 42.3994 85.3024 43.1856V43.1839Z", fill: "var(--sapContent_Illustrative_Color23)" }),
  ...
  (0, import_jsx_runtime.jsx)("path", { d: "M64.0099 59.0599C64.0099 59.0599 65.6972 58.2649 64.2047 57.1239C62.7627 56.0193 62.4775 57.2822 62.4775 57.2822C62.4775 57.2822 62.888 58.1901 64.0099 59.0599Z", fill: "var(--sapContent_Illustrative_Color23)" }),
  (0, import_jsx_runtime.jsx)("path", { d: "M86.4608 99.8283L99.5152 90.8493L95.798 84.2812C95.798 84.2812 88.8751 88.4141 83.5768 90.8146L86.459 99.8283H86.4608Z", fill: "var(--sapContent_Illustrative_Color8)" }),
  (0, import_jsx_runtime.jsx)("path", { d: "M116.835 122.968C110.101 110.025 99.8683 90.6842 98.8368 88.4316C98.8368 88.4316 84.236 95.1737 84.4517 96.8105C84.6796 98.5395 90.8319 112.524 95.5058 122.97H116.835V122.968Z", fill: "var(--sapContent_Illustrative_Color13)" }),
  (0, import_jsx_runtime.jsx)("path", { d: "M97.5131 122.968C95.3875 118.616 93.6724 114.001 92.9558 109.195C92.5975 106.789 92.4774 104.339 92.761 101.917C92.881 100.893 93.0219 99.8317 93.3959 98.8628C93.7055 98.0627 94.1508 97.339 94.7039 96.685C96.3459 94.7403 98.7168 93.5819 100.585 91.8964C99.6735 90.1326 99.0507 88.9046 98.8333 88.4297C98.8333 88.4297 84.2325 95.1717 84.4482 96.8085C84.6761 98.5375 90.8285 112.523 95.5023 122.968H97.5114H97.5131Z", fill: "var(--sapContent_Illustrative_Color22)" }),
  (0, import_jsx_runtime.jsx)("path", { d: "M72.5262 122.968C76.6574 109.875 82.4427 90.6181 82.4427 90.6181L65.8485 83.8447L50.9886 122.968H72.5262Z", fill: "var(--sapContent_Illustrative_Color13)" }),
  (0, import_jsx_runtime.jsx)("path", { d: "M55.318 122.968C55.6363 121.604 56.0086 120.253 56.4156 118.913C57.0888 116.701 57.8611 114.52 58.6908 112.361C59.5275 110.183 60.4267 108.03 61.3591 105.89C62.2201 103.916 63.1124 101.956 64.0187 100.001C64.0621 99.9066 64.1161 99.7831 64.1804 99.6335C67.2018 92.5297 74.944 88.6856 82.4201 90.6129L82.4427 90.6181L65.8485 83.8447L50.9886 122.968H55.318Z", fill: "var(--sapContent_Illustrative_Color22)" })
] });
var Medium_default = Medium;
export {
  Medium_default as default
};
//# sourceMappingURL=Medium-CONM3C6C-LXRZKEXA.js.map

...
// node_modules/@sap-ui/fx-components/dist/Small-36WJC3FG.js
var import_jsx_runtime = __toESM(require_jsx_runtime(), 1);
var Small = ({ className }) => (0, import_jsx_runtime.jsxs)("svg", { xmlns: "http://www.w3.org/2000/svg", width: "128", height: "128", fill: "none", viewBox: "0 0 128 128", className, children: [
  (0, import_jsx_runtime.jsx)("rect", { width: "128", height: "55", y: "40", fill: "var(--sapContent_Illustrative_Color20)", rx: "8" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color2)", d: "M19.177 54.377c0-.343-.995-.617-2.324-.68-.076-1.328-.37-2.315-.712-2.314-.343 0-.628.995-.7 2.33-1.334.091-2.325.39-2.32.733.004.343.994.618 2.324.68.08 1.327.368 2.315.71 2.314.343 0 .63-.996.702-2.33 1.334-.092 2.324-.39 2.32-.733Z" }),
  (0, import_jsx_runtime.jsx)("circle", { cx: "109.623", cy: "61.548", r: ".783", fill: "var(--sapContent_Illustrative_Color20)" }),
  (0, import_jsx_runtime.jsx)("circle", { cx: "11.698", cy: "85.05", r: ".783", fill: "var(--sapContent_Illustrative_Color20)" }),
  (0, import_jsx_runtime.jsx)("circle", { cx: "39.117", cy: "69.382", r: ".783", fill: "var(--sapContent_Illustrative_Color20)" }),
  (0, import_jsx_runtime.jsx)("circle", { cx: "41.468", cy: "74.083", r: "1.175", fill: "var(--sapContent_Illustrative_Color20)" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color2)", d: "M22.52 59.586c0-.222-.643-.4-1.503-.44-.049-.858-.238-1.497-.46-1.496-.222 0-.406.644-.453 1.507-.862.059-1.503.252-1.5.474.003.222.643.4 1.503.44.051.858.238 1.496.46 1.496.22 0 .406-.644.453-1.507.862-.06 1.503-.252 1.5-.474Zm83.041 11.751c0-.222-.643-.4-1.503-.44-.049-.858-.238-1.497-.46-1.496-.222 0-.406.644-.453 1.507-.862.059-1.503.252-1.5.474.002.222.643.4 1.503.44.051.858.238 1.496.459 1.496.222 0 .407-.644.454-1.507.862-.06 1.503-.252 1.5-.474Z" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color24)", d: "M89.007 36.093c-2.692-1.005-3.427-.207-4.57 0-1.004 14.401-2.489 43.519.847 43.928 4.307.529 5.048 1.015 7.949-.352.757-.357.959-4.445 1.39-7.695.39-2.948 2.484-23.834 2.692-26.326.208-2.493.426-5.642-2.1-6.743-1.562-.68-4.99-2.357-6.208-2.812Z" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color1)", d: "M92.813 41.47c-.416-.581-6.364-3.933-9.757-4.245-1.73 13.155-5.12 41.303-4.538 41.552.726.312 10.593 1.973 11.839 1.766 1.246-.208.727-3.428 1.558-7.166.83-3.739 2.907-22.536 3.219-23.783.312-1.246-1.802-7.397-2.322-8.124Z" }),
  ...
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color24)", d: "m65.086 54.886 2.437-1.206 11.974 2.428-1.749 1.604-12.662-2.826Z" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color1)", d: "m78.245 63.694-1.274 1.595.772-7.577 1.749-1.605-1.247 7.587ZM65.73 56.105l10.938 2.374-.27 2.573-10.803-2.745.135-2.202Z" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color8)", d: "M66.726 45.381c0-.614.81-2.546 1.105-3.328 2.298-2.134 6.055-.939 11.447.298 4.053.93 6.055 2.091 6.895 3.414.84 1.323-.715 2.579-1.636 3.286-1.723 1.323-6.187 2.645-9.679 2.688-3.492.043-5.67-1.588-7.027-2.688-1.222-.99-1.105-2.902-1.105-3.67Z" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color25)", d: "M66.862 46.157c-.481-.756.33-2.526.645-3.127 1.417-4.21 15.645.184 16.89.442 1.246.258 2.276 1.374 0 3.522-2.276 2.147-8.503 2.577-11.38 2.319-2.878-.258-5.554-2.211-6.155-3.156Z" }),
  ...
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color25)", d: "M83.328 28.463c2.192 1.215 3.505 3.538 3.781 4.169.665 1.518.684 2.888.684 3.99-1.007-4.608-5.062-8.159-11.186-8.159-4.124 0-4.205-.684-1.972-1.16 2.233-.477 5.954-.358 8.693 1.16Z" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color24)", d: "M73.234 27.497c-1.894.434-3.808 2.126-4.712 3.15-2.218 2.814-2.212 3.993-2.757 7.471-.546 3.48 1.947 6.542 1.947 6.542-1.383-3.939-.808-9.737 2.176-13.18 4.816-5.553 12.215-3.722 10.168-4.137-2.389-.483-4.476-.384-6.822.154Z" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color22)", d: "M74.578 47.71c4.737.124 7.934-1.832 8.94-2.825.181-.413.59-1.355.775-1.82-.968-.503-.774-1.47-.774-2.631 0-.93.697-1.497 1.045-1.665.077-.077.085-.642-.503-2.283-.736-2.052-2.787-4.22-6.658-5.458-3.87-1.238-6.308.31-8.553 1.82-2.245 1.509-2.206 7.044-1.974 8.515.232 1.47 1.78 6.192 7.702 6.347Z" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color8)", d: "M67.983 41.464c-1.335-4.511.885-7.617 2.18-8.386.656-.39-1.264 1.813-1.783 3.587-.816 2.792.355 6.13-.397 4.799Z" }),
  (0, import_jsx_runtime.jsx)("circle", { cx: "73.166", cy: "33.436", r: ".403", fill: "var(--sapContent_Illustrative_Color8)" }),
  (0, import_jsx_runtime.jsx)("circle", { cx: "70.778", cy: "34.735", r: ".403", fill: "var(--sapContent_Illustrative_Color8)" }),
  (0, import_jsx_runtime.jsx)("circle", { cx: "72.763", cy: "38.21", r: ".807", fill: "var(--sapContent_Illustrative_Color8)" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color24)", d: "m83.54 64.795 2.89 1.645-1.395 8.821c-.1.88.054 1.77.293 2.527.299.947-.093 1.859-.293 2.307-.16.36.326 1.19.293 1.721-.399-.631-1.688-1.8-1.29-2.717.499-1.147.35-1.595-.498-4.585-.847-2.99-.498-5.144 0-6.938.399-1.436.332-2.581 0-2.78Z" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color25)", d: "M82.222 67.997c.247-.577.309-2.028.31-2.68l1.752.928c0 .43-.093 1.525-.464 2.474-.371.949.155 6.376.464 8.971-.344-.928-1.175-2.887-1.753-3.3-.722-.515-3.764-.257-3.351-.412.412-.155 2.01-.155 3.042-.412 1.03-.258.31-.98 0-1.547s-1.083-1.238-1.65-1.495c-.567-.258-.413-.31 0-.619.412-.31 1.34-1.186 1.65-1.908Z" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color24)", d: "M59.468 63.728v-3.473c.47.313 1.476.947 1.737.976.325.036.904-.796 1.628-1.736.724-.941.255-.128.924.967 1.216 1.995-.575 3.92-.732 3.908.17.832.01 1.695-.192 2.766-.253 1.338-1.628 2.402-.888 4.023.65 1.424-.74-.385-.74-1.63 0-.736.29-2.419.705-3.903.09-.321.508-1.395.923-2.55-.217-.036-.796.145-1.303.362-.506.217-1.59 2.807-3.33 3.698-.672.344-1.762 3.291-3.586 4.445.591-1.134 1.678-1.971 1.824-4.089.095-1.374 3.03-3.547 3.03-3.764Z" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color25)", d: "M83.726 39.604c.334-.471 1.294-.757 1.66-.765-.46.383-.945.69-1.022 2.018-.076 1.33.943 1.888.413 1.888-.492 0-.889.076-1.17-.486-.28-.562-.401-1.923.119-2.655Z" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color22)", d: "M60.022 82.327c-.427-.844-.574-2.098-.156-2.516.23.272.607 1.77 1.874 3.227.922 1.06 3.921 3.869 7.998 6.628l.104 1.422c-.94-.564-3.166-2.125-4.77-3.279-2.007-1.442-4.408-4.216-5.05-5.482Zm21.302-24.908c.75-2.719 3.645-6.884 4.66-6.923l1.121-.33c.524-.164 2.572 1.094 1.42.959-1.09-.128-5.36 5.415-5.739 6.724-.378 1.31-.633 3.008-.297 5.21.269 1.761 2.724 3.08 3.94 3.496l.964.518c-1.095 1.524-3.032.743-4.904-1.601-2.17-2.717-2.102-4.656-1.165-8.053ZM63.22 54.807c.29-1.742 1.125-8.017 2.439-8.553h1.082s-.004.244.078.885c-.62.462-.688 1.754-.906 2.153-.272.499-1.925 11.26-1.698 12.213.182.762-1.365 2.343-1.864 2.933l.398-1.448c.12-2.117.18-6.44.47-8.183Z" }),
  (0, import_jsx_runtime.jsx)("path", { fill: "var(--sapContent_Illustrative_Color25)", d: "M86.878 42.364c-1.01 1.147-1.985.712-2.6.7 0 .18-.5 1.175-1.091 1.9-.591.726-1.873 1.499-4.312 2.267 0 0 2.171-.067 3.26-.512 1.09-.446 2.158-2.222 2.753-2.063.764.203 2.336-2.684 1.99-2.292Z" })
] });
var Small_default = Small;
export {
  Small_default as default
};
//# sourceMappingURL=Small-36WJC3FG-BMNQIDXL.js.map
